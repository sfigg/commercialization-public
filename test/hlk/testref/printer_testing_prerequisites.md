...
-   <xref local="BKMK_HCK_Printer_hR">Hardware requirements</b>.

-   <xref local="BKMK_HCK_Printer_sR">Software requirements</b>.

-   <xref local="BKMK_HCK_Printer_sC">Test computer configuration</b>.
