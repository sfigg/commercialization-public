...
-   One test computer. The test computers must meet the Windows HLK requirements as described in <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b> and the following operating system-specific requirements:
...
-   Windows symbol files. These are available from the <xref hlink="http://go.microsoft.com/fwlink/p/?LinkId=231439">Symbol Files website</b>.
