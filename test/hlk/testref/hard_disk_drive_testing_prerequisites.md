...
The hardware that's required for testing a hard drive varies depending on the connection type. But, all tests for hard disks require 1 test computer. The test computer must meet the Windows HLK requirements. For more information, see <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b>.
...
<mark type="bullet_intro">Device.Storage.Hd.Ehdd</b>
...
<mark type="bullet_intro">Device.Storage.Hd.Flush</b>

-   This feature and testing requires an external programmable power strip.

-   See the <xref rid="p_hlk_test.b7df764f-ab21-4e7a-9594-e6f814711b4d">Flush Test</b> for more details.

<mark type="bullet_intro">Device.Storage.Hd.Sata.HybridInformation</b>
...
<mark type="bullet_intro">Device.Storage.Hd.Trim</b>
...
<mark type="bullet_intro">Device.Storage.Hd.Uas</b>
