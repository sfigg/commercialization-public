...
-   <xref local="gen">General system server troubleshooting</b>

-   <xref local="failed">Troubleshooting failed system server tests</b>

-   <xref local="stress">Server stress tests</b>

-   <xref local="vm">Using virtual machines (VMs) in the test environment</b>

## General system server troubleshooting
...
1.  Review the following topics for help in server testing:
    ...
    -   <xref rid="p_hlk_test.server_testing_overview">Server Testing Overview</b>

    -   <xref rid="p_hlk_test.system_server_testing_prerequisites">System Server Testing Prerequisites</b>

    -   <xref rid="p_hlk_test.test_server_configuration">Test Server Configuration</b>

    -   <xref rid="p_hlk_test.318d804e-aa8f-4ffb-8ce2-963cea2f1a40">LoadGen Server Stress - Run First - Set Machine Policies</b>

    -   <xref rid="p_hlk_test.6e9adb95-fca5-4e15-a255-bc96c0d12aa9">LoadGen Server Stress - Start Test for Server</b>

    -   <xref rid="p_hlk_test.8cb4f87c-d2a4-4d90-92a7-edd016ccdeac">LoadGen Server Stress - Run Last - Reset Machine Policies</b>

    -   <xref rid="p_hlk.troubleshooting_windows_hlk">Troubleshooting Windows HLK</b>.
...
5.  Make sure that the system upon which the Windows HLK Controller is installed has adequate hardware capabilities to meet the test demands. See <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b> for a description of these hardware requirements. As the number of devices and systems that are being tested increases, you might need to add more processors, memory, or storage.

## Troubleshooting failed system server tests
...
## Using virtual machines (VMs) in the test environment
...
<seealso> <xref rid="p_hlk_test.system_server_tests">System.Server Testing</b> </seealso>
