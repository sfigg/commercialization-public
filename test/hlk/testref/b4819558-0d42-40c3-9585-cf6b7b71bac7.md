...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/70a63e1c-29c3-457a-87af-8fc74decf3ee">http://msdn.microsoft.com/en-us/library/windows/hardware/70a63e1c-29c3-457a-87af-8fc74decf3ee</b>
...
2.  Tests I/O on every device on the system using WDTF Simple I/O plugins. See <xref hlink="https://msdn.microsoft.com/library/windows/hardware/hh781398">Provided WDTF Simple I/O plug-ins</b> for more information.
3.  Disables and enables every device on the system using WDTF PnP action interfaces, see <xref hlink="https://msdn.microsoft.com/library/windows/hardware/hh451068">IWDTFPNPAction2::DisableDevice</b> and <xref hlink="https://msdn.microsoft.com/library/windows/hardware/hh451082">IWDTFPNPAction2::EnableDevice</b> methods for more information.
4.  Verifies that there are no devices on the system reporting device problem codes.
5.  Tests I/O on every device on the system using WDTF Simple I/O plugins. See <xref hlink="https://msdn.microsoft.com/library/windows/hardware/hh781398">Provided WDTF Simple I/O plug-ins</b> for more information.
