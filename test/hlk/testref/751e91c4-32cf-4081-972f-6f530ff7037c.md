...
# UCSI Power Direction Role command - Reset on disconnect
...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/f69baff4-4739-4989-be69-57944a41031b">http://msdn.microsoft.com/en-us/library/windows/hardware/f69baff4-4739-4989-be69-57944a41031b</b>


</conditional_block> Verifies that the power role requested using the UCSI Set Power Direction Role command persists only for the duration of the current connection.
