...
<mark type="bullet_intro">Document Terms</b>
...
>[!NOTE]
The term <mark type="term">cores</b> refers to physical processing cores (not virtual or hyper-threaded cores). If your device supports advanced features such as the ones below, then the minimum system requirements may be increased.
...
## Running the LAN tests in the HLK
...
7.  Click **software device**, and select the installed LWF driver you want to test.
    ...
    ![LWF Logo Test](../images/HCK_Win8_LAN_Running_LWF_Logo_Test.png)
