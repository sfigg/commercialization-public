...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/da0b2da1-2285-4129-a913-367bcc0052be">http://msdn.microsoft.com/en-us/library/windows/hardware/da0b2da1-2285-4129-a913-367bcc0052be</b>


</conditional_block>

This test uses the SetupDi API to send a <xref hlink="https://msdn.microsoft.com/library/windows/hardware/ff543717">DIF\_REMOVE</b> request for the installers to remove the device.
