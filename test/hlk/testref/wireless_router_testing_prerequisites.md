...
-   <xref local="BKMK_HCK_wRouter_hR">Hardware requirements</b>.

-   <xref local="BKMK_HCK_wRouter_sR">Software requirements</b>.

-   <xref local="BKMK_HCK_wRouter_tC">Test computer configuration</b>.

<mark type="bullet_intro">In this section:</b>

-   <xref rid="p_hlk_test.troubleshooting_wireless_router_testing">Troubleshooting Wireless Router Testing</b>
...
![Wireless Router Test Configuration](../images/HCK_Win8_LAN_Wireless_Router_Config.png)
>[!NOTE]
...
12. Make sure that all network connections are set to **Private** in the **Network Center** in the **Control Panel**.
    ...
    ![Local Group Policy Editor window](../images/HCK_Win8_Wireless_Router_Config_1_6_Grppol.png)

    ![Unidentified Networks Properties dialog box](../images/HCK_Win8_Wireless_Router_Config_1_6_Netprop.png)
...
![WTT: Manual Task Dialog Box](../images/HCK_Win8_Wireless_Router_ManualTaskDialogBox.png)
<mark type="bullet_intro">Feature Path:</b> $\\WDK Tests\\Networking\\Routers\\WCN
...
<mark type="bullet_intro">Feature Path:</b> $\\WDK Tests\\Networking\\Routers\\WCN Wireless
...
<mark type="bullet_intro"></b>Feature Path: $\\WDK Tests\\Networking\\Routers\\WCN Wireless
...
<mark type="bullet_intro">Test Case and Wireless Profile Mapping Table:</b>
