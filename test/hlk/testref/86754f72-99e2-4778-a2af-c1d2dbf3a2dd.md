...
# UCSI Get Connector Status - PD Reset Complete
...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/9f74f6b1-1628-403a-a3e6-1e8a8de17f8f">http://msdn.microsoft.com/en-us/library/windows/hardware/9f74f6b1-1628-403a-a3e6-1e8a8de17f8f</b>


</conditional_block> Verifies that the system reports a 'PD Reset Complete' notification in response to receiving a Power Delivery Hard Reset on a connector.
...
| <mark type="bullet_intro">PDResetCompleteNotification</b> | Set to False if the SUT cannot trigger the PD Reset Complete notification.                                                                                                                        |
