...
This test stresses the SRIOV capable miniport adapter in the presence of a vSwitch with VFs assigned. This is a single machine job and it needs additional configuration for execution. Please follow the same instructions as specified for the [NDISTest 6.5 - 1 Machine - SRIOVBasicVerification](616e3e15_2635_4810_b4bf_ec90eeb00a4f.md) test.
