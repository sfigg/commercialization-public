...
-   One test computer. The test computer must meet the Windows HLK requirements as described in <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b> and the following operating system-specific requirements.
...
1.  When the test computer is turned off, complete the following assembly steps:
    ...
    5.  Do one of the following:
        ...
        ![iSCSI controller configuration diagram (no bridge)](../images/HCK_Win8_iSCSI_HBA_Config_16_1.png)

        The following diagram shows the test system configuration with a bridge.

        ![iSCSI controller configuration diagram (bridge)](../images/HCK_Win8_iSCSI_HBA_Config_16_2.png)
...
4.  Install the latest version of the iSCSI software initiator. This is available from the <xref hlink="http://go.microsoft.com/fwlink/?LinkId=229004">Microsoft Download Center</b>.
