...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/3bb5363f-a469-4206-adda-b75c1567738e">http://msdn.microsoft.com/en-us/library/windows/hardware/3bb5363f-a469-4206-adda-b75c1567738e</b>


</conditional_block> Test that out of order and overlapping-aliased bindings are handled correctly. Defines a Root Signature that will cause 2 bindings to come from the same location and 1 binding that is out of order from the first two binding entries (further towards the start of the heap)
