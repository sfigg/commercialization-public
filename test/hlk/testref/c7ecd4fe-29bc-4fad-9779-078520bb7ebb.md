...
ms.assetid: 1eb38069-44ac-453a-aa8d-4ecf02d34964
...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/1eb38069-44ac-453a-aa8d-4ecf02d34964">http://msdn.microsoft.com/en-us/library/windows/hardware/1eb38069-44ac-453a-aa8d-4ecf02d34964</b>
...
5.  Verification
    1.  First eliminate all devnodes that failed with error 0xc0000490 (CM\_PROB\_FAILED\_INSTALL). These should NOT be considered
    2.  Look at all other devnodes that failed
    3.  Test fails if
        1.  Devnode was not seen in previous BSP
        2.  Devnode not failure cannot be justified and/or is unknown
