...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/c1ce571a-b039-41d4-b54b-aca35bc037d8">http://msdn.microsoft.com/en-us/library/windows/hardware/c1ce571a-b039-41d4-b54b-aca35bc037d8</b>
...
>[!NOTE]
This is a server-specific version of an existing test. For more information, please see <xref rid="p_hlk_test.738735f7-245a-4b39-9d81-20339ce31fd4">Disk Stress (LOGO)</b>.
...
For troubleshooting information, see <xref rid="p_hlk_test.troubleshooting_devicestorage_testing">Troubleshooting Device.Storage Testing</b> and <xref rid="p_hlk_test.troubleshooting_system_server_testing">Troubleshooting System Server Testing</b>.
...
|--------------------------------------------------|---------------------------------|
| <mark type="bullet_intro">LLU\_NetAccessOnly</b> | Net access LLU                  |
| <mark type="bullet_intro">LLU\_LclAdminUsr</b>   | Admin LLU                       |
| <mark type="bullet_intro">TestDuration</b>       | Duration of the entire test.    |
