...
-   One test computer. The test computers must meet the Windows HLK requirements as described in [Windows HLK Prerequisites](p_sxs_hlk.windows_hlk_prerequisites) and the following operating system-specific requirements:
