...
-   <xref local="BKMK_HCK_HMFT_hR">Hardware requirements</b>

-   <xref local="BKMK_HCK_HMFT_sR">Software requirements</b>

-   <xref local="BKMK_HCK_HMFT_tC">Test computer configuration</b>
...
-   A test computer.
    ...
    >[!NOTE]
    The test computer must meet the <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b>. It also must have at least 75 GB free on the drive used as the HLK working directory.
...
Before running the HMFT encoding and decoding tests, you must download the <xref hlink="http://msdn.microsoft.com/en-us/windows/hardware/hh852358">Windows Hardware Lab Kit (HLK) Supplemental Test Content for HMFT Multimedia Tests</b> from the Windows Dev Center. After downloading the supplemental test content, you must store this content in one of the following ways:
