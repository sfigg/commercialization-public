...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/e8d83bc0-3deb-4fd5-a186-9ca239d01bd5">http://msdn.microsoft.com/en-us/library/windows/hardware/e8d83bc0-3deb-4fd5-a186-9ca239d01bd5</b>


</conditional_block> Test that different shader stages can use the same register binding but reference different descriptors through the root signature parameter Shader Visibility functionality. Test uses all 5 3D shader stages, each reading from SRV0 and writting to UAV1. The UAVs are then verified to hold unique data from each stage
