...
-   Manual tests:
    ...
    If you are implementing effects for a Modern system with Microsoft Store App UI (Hardware Support App), you must expose UI to the user to enable/disable audio effects. Ensure that UI is functioning correctly for each applicable device. 
