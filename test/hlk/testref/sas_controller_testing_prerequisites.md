...
-   One test computer. The test computer must meet the Windows HLK requirements as described in <xref rid="p_sxs_hlk.windows_hlk_prerequisites">Windows HLK Prerequisites</b>. Additionally, the computer must meet the following operating system-specific requirements.
...
-   If the test device is an add-in controller that supports RAID, use the <xref local="BKMK_addin">Add-in RAID controller test configuration</b>.

-   If the test device is an integrated controller that supports RAID, use the <xref local="BKMK_integrated">Integrated RAID controller test configuration</b>.

-   If the test device does not support RAID, use the <xref local="BKMK_nonraid">Non-RAID controller test configuration</b>.
...
## Add-in RAID controller test configuration
...
9.  If you are testing by using a client operating system, create a 4-GB NTFS spanned volume that uses unallocated space on RAID Array 1, RAID Array 2, and RAID Array 3, as the following diagram shows.
    ...
    2.  Create a 4-GB NTFS software RAID 5 array that uses unallocated space on RAID Array 1, RAID Array 2, and RAID Array 3, as the following diagram shows.
        ...
        ![Add-in RAID array configuration diagram (server)](../images/HCK_Win8_ATA_RAID_Config_16_2.png)
...
## Integrated RAID controller test configuration
...
## Non-RAID controller test configuration
...
1.  When the test computer is turned off, complete the following assembly steps:
    ...
    5.  Attach the disks to the test devices according to the following table:
        ...
        ![Diagram of an add-in SAS assembly](../images/HCK_Win8_Non_RAID_Config_ADD_IN_SAS.png)

        SAS integrated controllers configuration diagram

        ![Diagram of an integrated SAS assembly](../images/HCK_Win8_Non_RAID_Config_Integrated_SAS.png)
