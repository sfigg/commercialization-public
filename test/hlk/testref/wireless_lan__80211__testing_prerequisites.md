...
-   <xref local="hcksetup">Windows HLK Setup for WLAN Device Testing </b>

-   <xref local="prepwlan">Prepare for Wireless LAN (802.11) Testing</b>

-   <xref local="run">Run Wireless LAN (802.11) tests for Certification</b>

-   <xref local="view">View Results and Log Files</b>

-   <xref local="pkg">Create a Package</b>

-   <xref local="notests">Notes and Troubleshooting for RT-N66U firmware</b>

-   <xref local="ap">AP Firmware Troubleshooting</b>

## Windows HLK Setup for WLAN Device Testing
...
## Prepare for Wireless LAN (802.11) Testing

<mark type="bullet_intro">RT-N66U (AP1 & AP2) Preparation:</b>
...
<mark type="bullet_intro">Topology Configuration and Preparation:</b>
...
<mark type="bullet_intro">AP Controller Configuration:</b>
...
<mark type="bullet_intro">HLK Pool Configuration:</b>
...
8.  Type the machine pool name in the **New Pool** field and then press <cmd_line>Enter</cmd_line>. The new machine pool should appear as a node under **$ (Root)**.

9.  Select the **Default pool.** The Windows HLK Client machines should be listed in the **Machines** list.

10. Press and hold the <cmd_line>CTRL</cmd_line> key and click each of the three defined machines to select all three machines.
...
## Run Wireless LAN (802.11) tests for Certification
...
2.  Type <cmd_line>RT-N66U</cmd_line> and then click **Search**.
