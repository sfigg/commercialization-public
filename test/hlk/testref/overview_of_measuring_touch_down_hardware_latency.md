...
![Circuit board for Touch Down Hardware Latency](../images/HCK_TouchDownHardwareLatency1.jpg)
...
![Circuit diagram for touch down hardware latency](../images/HCK_TouchDownHardwareLatency2.jpg)
...
![Circuit board with microphone attachment](../images/HCK_TouchDownHardwareLatency3.jpg)

Calibration plate input goes in the other hole, as shown in the following image.

![Calibration plate connected to circuit board](../images/HCK_TouchDownHardwareLatency4.jpg)
...
![Port C of circuit board](../images/HCK_TouchDownHardwareLatency5.jpg)
...
![Pins C0, C1, and ground highlighted](../images/HCK_TouchDownHardwareLatency6.jpg)

For more information about this board please visit manufacturer’s <xref hlink="http://www.atmel.com/tools/AT90USBKEY.aspx">web site</b> and <xref hlink="http://www.atmel.com/Images/doc7627.pdf">hardware user guide</b> for the board.
