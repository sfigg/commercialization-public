...
# UCSI USB Operation Role command - Reset on disconnect
...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/e0cfb2ef-b35a-4617-86c7-71bb375ef397">http://msdn.microsoft.com/en-us/library/windows/hardware/e0cfb2ef-b35a-4617-86c7-71bb375ef397</b>


</conditional_block> Verifies that the data role requested using the UCSI Set USB Operation Role command persists only for the duration of the current connection.
