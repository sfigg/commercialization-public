...
Description: Camera Driver Controls Device Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_CUSTOM enum all, photo and preview
...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/66860d92-d432-4f6b-99b9-abc16a4e3ad0">http://msdn.microsoft.com/en-us/library/windows/hardware/66860d92-d432-4f6b-99b9-abc16a4e3ad0</b>
...
<mark type="bullet_intro">Step-by-step instructions for setting up the test:</b>

Watch the following video demonstration.

<video still_img_src="images/VideoTitlePg_.png" uuid="caa1967e-1e59-484a-b55b-23dd3efe70d7">
</video>

<xref hlink="http://content5.catalog.video.msn.com/e2/ds/c7cb1516-1219-45d7-a3e1-cc757efdf16c.mp4">Download the video (MP4)</b>

<xref hlink="mailto:lhdocfb@microsoft.com?subject=HCKWebcamSensorQTestSetupVIDEO&amp;body=%0D%0A%0D%0AMicrosoft uses your feedback to improve its products, services and documentation. While we are investigating the issue you report, we may send e-mail to you to ask for further details or clarification on the feedback you send to us, and we may send e-mail to you to let you know that your feedback has been addressed.  We do not use your e-mail address for any other purpose.%0D%0AFor technical support, contact http://go.microsoft.com/fwlink/?LinkId=143702.%0D%0A%0D%0A For further information about the Microsoft Online Privacy Statement, please see http://go.microsoft.com/fwlink/?LinkId=143701.">Send feedback about this video</b>
...
1.  Video test chart:
    ...
    -   Printout of the test chart (that is shown in *REF \_Ref311027164 \\h Figure 1. Video Test Chart*), on matte paper by using a high quality inkjet (for example, an HP Z2100). You can access and print this high resolution PDF test chart from: <xref hlink="http://download.microsoft.com/download/8/0/0/80080840-64DC-4929-9B67-16B83E946C6B/HLK Video Test Chart.pdf">http://download.microsoft.com/download/8/0/0/80080840-64DC-4929-9B67-16B83E946C6B/HLK Video Test Chart.pdf</b>.

        ![Example test poster](../images/HCK_WinB_Figure1_TestPoster.jpg)
...
2.  Dimmable lights
    ...
    -   Two units <xref hlink="http://www.amazon.com/Philips-424382-11-watt-Household-Dimmable/dp/B00APTS03K">Philips 424382 11-Watt A19 LED Light Bulb, Dimmable</b>
    ...
    ![Video test setup](../images/Fig2_VideoTestSetup_WebcamCaptureRequirementsTest.jpg)
...
![Keystoning problem](../images/HCK_WinB_Figure3_Keystoning_CameraDiscretional.png)

In *Figure 4. Position Not Level*, position markers form a rectangle that is rotated relative to the field of view.

![Camera not level](../images/HCK_WinB_Figure4_NotLevel_CameraDiscretional.png)

*Figure 5. Poor Centering*, shows two or more image markers that are outside of the field of view.

![Not centered](../images/HCK_WinB_Figure5_NotCentered_CameraDiscretional.png)
