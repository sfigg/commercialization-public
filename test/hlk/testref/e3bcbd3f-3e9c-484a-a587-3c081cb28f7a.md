...
-   <xref hlink="http://msdn.microsoft.com/en-us/library/windows/hardware/cd4791aa-b5f7-4791-8dd1-82844b9bb3fc">http://msdn.microsoft.com/en-us/library/windows/hardware/cd4791aa-b5f7-4791-8dd1-82844b9bb3fc</b>


</conditional_block>

This automated test verifies that the **GetNamedPipeInfo** function returns the correct option when the named pipe is created with the **PIPE\_REJECT\_REMOTE\_CLIENTS** option. For more information about **PIPE\_REJECT\_REMOTE\_CLIENTS**, see <xref hlink="http://go.microsoft.com/fwlink/p/?LinkId=236052">CreateNamedPipe Function</b> in the MSDN® Library.
