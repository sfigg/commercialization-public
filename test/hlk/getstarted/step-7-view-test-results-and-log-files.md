...
-   [Bugcheck Summary information](..\user\hlk_studio___results_tab#sysx) for system crashes that occur during test runs
...
To learn more about the different options on this page, including distributed and multi-device support, see [HLK Studio - Results Tab](..\user\hlk_studio___results_tab).
