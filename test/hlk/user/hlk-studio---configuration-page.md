...
-   [Create a machine pool](..\getstarted\step_3_create_a_machine_pool)
...
-   [Manually configure HLK Client kernel debugger settings](..\user\manually_configure_hck_client_kernel_debugger_settings)
