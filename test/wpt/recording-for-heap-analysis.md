...
(Using Wpr.exe)
1.  Enable Heap tracking by setting IFEO registry : wpr.exe -HeapTracingConfig *&lt;process\_name&gt;* enable

2.  Start tracing session : wpr.exe -start Heap \[-filemode\]

3.  test scenario

4.  Stop tracing session : wpr.exe -stop *&lt;file\_name&gt;*

5.  Disable Heap tracking : wpr.exe -HeapTracingConfig *&lt;process\_name&gt;* disable
