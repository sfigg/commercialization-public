...
> [!Important]
> Don't add exclusions for the following items:
>
...
>
> Also, do not add exclusions for the following items:
>
...
> * Paging files.
>
> Adding exclusions for these items is unsupported and may lead to unpredictable results. It's OK to exclude subdirectories and files under these items.
