...
| [Sending SMS messages to SMTP addresses](sending-sms-messages-to-smtp-addresses.md)   | Partners can configure SMS messages to be sent to email addresses as well as phone numbers.   |
