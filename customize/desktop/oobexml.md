...
You can customize OOBE.xml settings differently per language and region that you intend to deploy in. For nore information, see [How OObe.xml works](https://docs.microsoft.com/en-us/windows-hardware/manufacture/desktop/how-oobexml-works).
