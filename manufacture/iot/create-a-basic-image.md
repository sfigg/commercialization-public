...
> [!IMPORTANT]
> For the powershell based commands for creating a basic image, see [Create a Basic Image](https://github.com/ms-iot/iot-adk-addonkit/blob/master/Tools/README.md#create-a-basic-image)
