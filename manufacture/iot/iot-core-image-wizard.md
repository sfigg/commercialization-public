...
4. For Windows 10 October 2018 Update, the RSAT: Server Manager optional feature is needed.  Previous versions use the [package](https://www.microsoft.com/en-us/download/details.aspx?id=45520)
