...
When developing your own board, see the [Minimum hardware requirements for IoT Core](https://docs.microsoft.com/en-us/windows-hardware/design/minimum/minimum-hardware-requirements-overview#iotcore).
