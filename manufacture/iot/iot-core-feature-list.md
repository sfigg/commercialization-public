...
| **IOT\_ONBOARDING_APP** | Provides a means of setting up the device’s WiFi connection if no other WiFi profile was configured.  It places the WiFi adapter into a Soft-AP mode so a phone or other device can connect to it. This is new in Windows 10, version 1709. |
...
| **IOT\_BLUETOOTH\_A2DP\_SOURCE** | Allows the device to play to an external device (e.g. a Bluetooth speaker). This is new in Windows 10, version 1803 |
| **IOT\_BLUETOOTH\_HFP\_AUDIOGATEWAY** | HFP AudioGateway allows the device to serve as a gateway device for phone calls. An application can interact with the calling functions of a paired Bluetooth headset by using APIs under Windows.ApplicationModel.Calls, specifically the VoipPhoneCall class. This is new in Windows 10, version 1803. |
| **IOT\_HEADLESS\_CONFIGURATION** | |
| **IOT\_NARRATOR** | |
| **IOT\_OCR\_ALL\_LANGS** | |
| **IOT\_OCR\_EN\_US** | |
...
| ~~IOT\_APPLICATIONS~~ (Deprecated)           | Deprecated in Windows 10, 1809 release along with IOT\_CORTANA feature. Adds Account Management host application, enables MSA sign-in. Required for Cortana. This is new in Windows 10, version 1703. |
...
| ~~IOT\_GENERIC\_POP~~ (Deprecated)   | In Windows 10 1809, this is deprecated and the device will get OS only updates by default. Adds the Generic device targeting info for OS only Updates. Supported starting with Windows 10, version 1607. |
...
| ~~IOT\_CORTANA~~ (Deprecated) | Deprecated in Windows 10, 1809 release. See Cortana SDK for including Cortana to your device. Adds Cortana feature. Requires **IOT\_APPLICATIONS** feature. This is new in Windows 10, version 1703.       |
| ~~IOT\_CORTANA\_OBSCURELAUNCH~~ (Deprecated) | Deprecated in Windows 10, 1809 release along with IOT\_CORTANA feature. Enables running Cortana application on boot. This add-on causes Cortana to run in the background resulting in better response time for Cortana. This is new in Windows 10, version 1703. |

### Speech Data

| Features                       | Description                                                                         |
|--------------------------------|-------------------------------------------------------------------------------------|
| **IOT\_SPEECHDATA\_AR\_SA** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_DE\_DE** | Adds speech data for German.|
| **IOT\_SPEECHDATA\_EL\_GR** | Adds speech data for . This is new in Windows 10, version 1809.|
...
| **IOT\_SPEECHDATA\_KO\_KR** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_NL\_NL** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_PL\_PL** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_PT\_BR** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_PT\_PT** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_RO\_RO** | Adds speech data for . This is new in Windows 10, version 1809.|
| **IOT\_SPEECHDATA\_RU\_RU** | Adds speech data for . This is new in Windows 10, version 1809.|
...
| **CUSTOM_SETTINGS** | Includes registry settings to disable display on crash (BSOD). Use **IOT\_CRASHCONTROL\_SETTINGS** instead of this feature. See [Crash settings](https://docs.microsoft.com/windows-hardware/manufacture/iot/oscustomizations#crash-settings) |
