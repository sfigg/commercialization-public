...
<xs:schema targetNamespace="http://schemas.microsoft.com/phone/2011/10/BootConfiguration" elementFormDefault="qualified" xmlns="http://schemas.microsoft.com/phone/2011/10/BootConfiguration" xmlns:mstns="http://schemas.microsoft.com/phone/2011/10/BootConfiguration" xmlns:xs="http://www.w3.org/2001/XMLSchema">
                                                      ...
                                                      <xs:complexType>
                                                        <xs:sequence>
                                                          <xs:element name="StringValues" minOccurs="1" maxOccurs="1">
                                                            <xs:complexType>
                                                              <xs:sequence>
                                                                <xs:element name="StringValue" minOccurs="1" maxOccurs="unbounded" type="xs:string"/>
                                                              </xs:sequence>
                                                            </xs:complexType>
                                                          </xs:element>
                                                        </xs:sequence>
