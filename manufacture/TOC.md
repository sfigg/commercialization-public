...
### [Windows Core vs legacy desktop](wcos/wcos-desktop-comparison.md)
### [Get the tools needed to customize WCOS](wcos/set-up-your-pc-to-customize-core.md)
### [Factory OS](wcos/factory-os.md)
#### [Build Factory OS](wcos/factory-os-build.md)
### [Create Windows Universal OEM Packages](wcos/create-packages.md)
#### [Windows Universal OEM Package Schema](wcos/package-schema.md)
### [Add a package to a feature manifest file](wcos/add-a-package-to-a-feature-manifest-file.md)
### [Configure the OEMInput file](wcos/configure-the-oeminput-file.md)
### [Build an image using ImgGen](wcos/build-a-customized-image-using-imggen.md)
### [Sign an image](wcos/sign-an-image.md)
### [Flash an image to a device](wcos/flash-an-image-to-a-device.md)
