...
##### [Add languages to Windows images](desktop/add-and-remove-language-packs-offline-using-dism.md)
##### [Add languages to Windows Setup](desktop/add-multilingual-support-to-windows-setup.md)
#### [Add languages to a Windows distribution share](desktop/add-multilingual-support-to-a-windows-distribution.md)
