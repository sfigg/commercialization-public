...
To find out how to work with siloed provisioning packages, see [Lab 11: Add Windows desktop applications with siloed provisioning packages](add-desktop-apps-wth-spps-sxs.md).
