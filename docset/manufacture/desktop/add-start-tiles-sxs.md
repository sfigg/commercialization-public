---
author: KPacquer
Description: 'Lab 13: Add Start tiles and taskbar pins'
MSHAttr: 'PreferredLib:/library/windows/hardware'
title: 'Lab 13: Add Start tiles and taskbar pins'
---

# <span id="Add_apps"></span>Lab 13: Add Start tiles and taskbar pins
...
**Note**  The Start layout and taskbar pins can be lost if the user resets their PC with the built-in recovery tools. To make sure these settings stay on the device, see [Lab 14: Update the recovery image](update-the-recovery-image.md).
...
Next steps: [Lab 14: Update the recovery image](update-the-recovery-image.md)