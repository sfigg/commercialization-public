...
- **Add your languages to your recovery image, too**: Many common languages can be added to your recovery image. We'll show you how to add these later in [Lab 13: Update the recovery image](update-the-recovery-image.md).
