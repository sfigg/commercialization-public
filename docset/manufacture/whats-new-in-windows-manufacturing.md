...
-  In Windows 10, Version 1507, it's no longer necessary to reinstall inbox apps when adding a language pack. In fact, we now recommend that you don't, because otherwise DISM command may fail. 
   Updated topics: 
