...
The following tables record the changes that were made in the **Customize** section of the Windows 10 partner documentation.
...
<tbody>
<tr class="odd">
<td><p>[Microsoft-Windows-RemoteAssistance-Exe-fEnableChatControl](p_unattend.fenablechatcontrol)</p></td>
<td><p>New.</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p>Enable Messaging everywhere</p></td>
<td><p>Removed the topic. The feature is no longer shipping in Windows 10, version 1607.</p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p>Unattend: OfflineUserAccounts and OfflineDomainAccounts Group setting</p></td>
<td><p>Updated. Reduced the number of Groups that can be reliably supported offline. The removed items (CryptoOperators, DCOMUsers, IUsers, NetworkConfigurationOperators, PerfLoggingUsers, PerfMonitoringUsers, and RemoteDesktopUsers) are no longer supported for offline pass.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><p>[Lid open wake action](p_customize_converged.lid_open_wake_action)</p></td>
