...
<li>[Browser/Homepages](customize/mdm/policy-configuration-service-provider#browser-homepages)</li>
<li>[DeviceLock/MaxInactivityTimeDeviceLock](customize/mdm/policy-configuration-service-provider#devicelock-maxinactivitytimedevicelock)</li>
<li>[Experience/ConfigureWindowsSpotlightOnLockScreen](customize/mdm/policy-configuration-service-provider#experience-configurewindowsspotlightonlockscreen)</li>
</ul></p>
</td>
</tr>
</tbody>
