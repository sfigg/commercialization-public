...
| Accesstoken | Custom parameter for MDM servers to use as they see fit. Typically, can be used as a token to validate the enrollment request. Added in Windows 10, version 1703. | string |
| Deviceidentifier | Custom parameter for MDM servers to use as they see fit. Typically, can be used to pass in a unique device identifier. Added in Windows 10, version 1703. | GUID |
| Tenantidentifier | Custom parameter for MDM servers to use as they see fit. Typically, can be used to identify which tenant the device or user belongs to. Added in Windows 10, version 1703. | GUID or string |
| Ownership | Custom parameter for MDM servers to use as they see fit. Typically, can be used to determine whether the device is BYOD or Corp Owned. Added in Windows 10, version 1703. | 1, 2, or 3 |
 
