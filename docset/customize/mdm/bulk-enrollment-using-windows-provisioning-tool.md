...
-   [Apply a package to a Windows 10 desktop edition image](https://msdn.microsoft.com/library/windows/hardware/dn916107.aspx#to-apply-a-provisioning-package-to-a-desktop-image) - topic in MSDN
-   [Apply a package to a Windows 10 Mobile image](https://msdn.microsoft.com/library/windows/hardware/dn916107.aspx#to-apply-a-provisioning-package-to-a-mobile-image) - topic in MSDN.
