...
2.  In the Test group, set up rules to auto approve all updates.
...
## <a href="" id="screenshotsofserversync"></a>Process flow diagram and screenshots of server sync process
