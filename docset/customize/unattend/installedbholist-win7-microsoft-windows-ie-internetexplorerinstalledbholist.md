...
`InstalledBHOList` can contain one or more [AddonGuidItem](addonguiditem-win7-microsoft-windows-ie-internetexplorerinstalledbholistaddonguiditem.md) settings each of which represents a single Browser Help Object. For more information, see the MSDN topic: [Building Browser Helper Objects](http://go.microsoft.com/fwlink/?LinkId=136975).
...
<tbody>
<tr class="odd">
<td><p>[AddonGuidItem](addonguiditem-win7-microsoft-windows-ie-internetexplorerinstalledbholistaddonguiditem.md)</p></td>
