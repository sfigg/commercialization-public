...
<tbody>
<tr class="odd">
<td><p>[Key](key-win7-microsoft-windows-tabletpc-platform-input-corelinearitydatadeviceelementkey.md)</p></td>
<td><p>Specifies a unique key for the <code>DeviceElement</code>.</p></td>
</tr>
<tr class="even">
<td><p>[Value](value-win7-microsoft-windows-tabletpc-platform-input-corelinearitydatadeviceelementvalue.md)</p></td>
...
[Microsoft-Windows-TabletPC-Platform-Input-Core](microsoft-windows-tabletpc-platform-input-core-win7-microsoft-windows-tabletpc-platform-input-core.md) | [LinearityData](linearitydata-win7-microsoft-windows-tabletpc-platform-input-corelinearitydata.md) | **DeviceElement**
