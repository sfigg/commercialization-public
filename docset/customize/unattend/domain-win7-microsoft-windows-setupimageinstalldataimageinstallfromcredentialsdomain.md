...
`Domain` specifies the domain of the account used for authentication to access the data image specified by [InstallFrom](installfrom-win7-microsoft-windows-setupimageinstalldataimageinstallfrom.md).
