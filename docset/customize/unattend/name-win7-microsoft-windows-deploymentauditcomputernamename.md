...
<td><p>Specifies the name of the computer. If you do not specify a name and the [MustReboot](mustreboot-win7-microsoft-windows-deploymentauditcomputernamemustreboot.md) setting is present, this setting is ignored. The <em>name</em> value is a string with a maximum length of 15 characters.</p></td>
</tr>
</tbody>
</table>
...
If you specify a new computer name, you might have to restart the computer for it to take effect. If additional processing is dependent on the new computer name, set the [MustReboot](mustreboot-win7-microsoft-windows-deploymentauditcomputernamemustreboot.md) value to **true** to restart the computer immediately.
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [AuditComputerName](auditcomputername-win7-microsoft-windows-deploymentauditcomputername.md) | **Name**
