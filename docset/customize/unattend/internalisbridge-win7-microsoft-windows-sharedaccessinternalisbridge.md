...
**Note**  
If this value is set to **true**, you cannot set a value for [InternalAdapter](internaladapter-win7-microsoft-windows-sharedaccessinternaladapter.md), and [EnableICS](enableics-win7-microsoft-windows-sharedaccessenableics.md) must also be **true**.
