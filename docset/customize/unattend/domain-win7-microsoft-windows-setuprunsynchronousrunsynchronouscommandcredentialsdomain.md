...
`Domain` specifies the domain of the account used to authentication access to the location specified by [Path](path-win7-microsoft-windows-setuprunsynchronousrunsynchronouscommandpath.md).
