...
`WillShowUI` specifies in what circumstances to display the user interface (UI) for disk configuration. Settings in [DiskConfiguration](diskconfiguration-win7-microsoft-windows-setupdiskconfiguration.md) are processed before the UI is displayed, but setting this value to **Always** or **OnError** gives notification of success or failure.
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [DiskConfiguration](diskconfiguration-win7-microsoft-windows-setupdiskconfiguration.md) | **WillShowUI**
