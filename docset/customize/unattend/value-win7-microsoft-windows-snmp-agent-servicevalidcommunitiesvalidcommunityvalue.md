...
`Value` specifies a value for [ValidCommunity](validcommunity-win7-microsoft-windows-snmp-agent-servicevalidcommunitiesvalidcommunity.md).

**Note**  
This element does not appear in the **Properties** pane of Windows® System Image Manager (Windows SIM) until you add [ValidCommunity](validcommunity-win7-microsoft-windows-snmp-agent-servicevalidcommunitiesvalidcommunity.md) to the answer file.
...
[Microsoft-Windows-SNMP-Agent-Service](microsoft-windows-snmp-agent-service-win7-microsoft-windows-snmp-agent-service.md) | [ValidCommunities](validcommunities-win7-microsoft-windows-snmp-agent-servicevalidcommunities.md) | [ValidCommunity](validcommunity-win7-microsoft-windows-snmp-agent-servicevalidcommunitiesvalidcommunity.md) | **Value**
