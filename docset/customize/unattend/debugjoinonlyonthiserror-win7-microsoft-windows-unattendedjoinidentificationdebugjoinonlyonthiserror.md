...
This setting modifies the behavior of [DebugJoin](debugjoin-win7-microsoft-windows-unattendedjoinidentificationdebugjoin.md). If specified, this setting causes the DebugJoin behavior only when the domain join operation fails with the error specified by this setting.

`DebugJoinOnlyOnThisError` only functions if [DebugJoin](debugjoin-win7-microsoft-windows-unattendedjoinidentificationdebugjoin.md) is set to **true**.
...
[Microsoft-Windows-UnattendedJoin](microsoft-windows-unattendedjoin-win7-microsoft-windows-unattendedjoin.md) | [Identification](identification-win7-microsoft-windows-unattendedjoinidentification.md) | **DebugJoinOnlyOnThisError**
