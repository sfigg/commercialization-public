...
`AssociationData` contains one or more instances of [AssociationElement](associationelement-win7-microsoft-windows-tabletpc-platform-input-coreassociationdataassociationelement.md). The AssociationElement specifies information to associate a Tablet PC monitor to the digitizer. Add a separate AssociationElement for each Tablet PC monitor that you want to associate to a digitizer.
...
<tbody>
<tr class="odd">
<td><p>[AssociationElement](associationelement-win7-microsoft-windows-tabletpc-platform-input-coreassociationdataassociationelement.md)</p></td>
