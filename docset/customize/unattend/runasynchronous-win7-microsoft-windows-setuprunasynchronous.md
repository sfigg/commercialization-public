...
To run services or commands that can start at the same time, use asynchronous commands. To run commands that need to finish before other commands can start, use [RunSynchronous](runsynchronous-win7-microsoft-windows-setuprunsynchronous.md) instead.
...
<tbody>
<tr class="odd">
<td><p>[RunAsynchronousCommand](runasynchronouscommand-win7-microsoft-windows-setuprunasynchronousrunasynchronouscommand.md)</p></td>
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | **RunAsynchronous**
