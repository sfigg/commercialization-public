...
`ItemName` is the display name of [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md).
...
<td><p>Specifies the display name to use for [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md) | **ItemName**
