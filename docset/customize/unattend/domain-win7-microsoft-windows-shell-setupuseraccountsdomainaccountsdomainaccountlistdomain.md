...
`Domain` specifies the name of the domain for a [DomainAccountList](domainaccountlist-win7-microsoft-windows-shell-setupuseraccountsdomainaccountsdomainaccountlist.md).
...
<td><p>Specifies the name of the domain for a [DomainAccountList](domainaccountlist-win7-microsoft-windows-shell-setupuseraccountsdomainaccountsdomainaccountlist.md). <em>Path_to_file</em> is a string.</p></td>
</tr>
</tbody>
</table>
