...
`PlainText` specifies whether the LocalAccount/Password/[Value](value-win7-microsoft-windows-shell-setupuseraccountslocalaccountslocalaccountpasswordvalue.md) is hidden in the unattended installation answer file.
