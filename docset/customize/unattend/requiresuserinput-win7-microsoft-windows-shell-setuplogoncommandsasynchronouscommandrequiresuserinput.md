...
**Note**  
Unlike synchronous commands, asynchronous commands may start and finish in any order. They cannot delay the appearance of the Windows® desktop, even if the asynchronous command requires user input. If an asynchronous command requires user input, the end user will see the input window after the desktop appears. For information about synchronous commands, see [SynchronousCommand](synchronouscommand-win7-microsoft-windows-shell-setupfirstlogoncommandssynchronouscommand.md).
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [LogonCommands](logoncommands-win7-microsoft-windows-shell-setuplogoncommands.md) | [AsynchronousCommand](asynchronouscommand-win7-microsoft-windows-shell-setuplogoncommandsasynchronouscommand.md) | **RequiresUserInput**
