...
`ItemName` is the display name of [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md).
...
<td><p>Specifies the display name to use [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md) | **ItemName**
