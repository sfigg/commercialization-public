...
<p>When CreatePartition\[Type](type-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitiontype.md) is set to <strong>Primary</strong> or <strong>Logical</strong>, this is the default file format.</p></td>
</tr>
<tr class="even">
<td><p><strong>FAT32</strong></p></td>
<td><p>Formats the partition for the File Allocation Table (FAT) file system.</p>
<p>When CreatePartition\[Type](type-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitiontype.md) is set to <strong>EFI</strong>, this is the default file format.</p></td>
</tr>
</tbody>
</table>
...
When CreatePartition\\[Type](type-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitiontype.md) is set to **Extended** or **MSR**, the partition does not receive a file format.
