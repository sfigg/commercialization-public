...
-   **To specify a newly-created partition to fill the remainder of the hard disk**
    ...
    Set `CreatePartitions:`[Extend](extend-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitionextend.md) to `true`, and leave `ModifyPartitions:Extend` empty.
