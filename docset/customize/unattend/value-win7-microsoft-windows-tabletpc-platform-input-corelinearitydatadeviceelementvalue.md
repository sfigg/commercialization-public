...
`Value` specifies the value of the [DeviceElement](deviceelement-win7-microsoft-windows-tabletpc-platform-input-corelinearitydatadeviceelement.md).
...
<td><p>Specifies the value of the [DeviceElement](deviceelement-win7-microsoft-windows-tabletpc-platform-input-corelinearitydatadeviceelement.md). <em>Value</em> is a string.</p></td>
</tr>
</tbody>
</table>
