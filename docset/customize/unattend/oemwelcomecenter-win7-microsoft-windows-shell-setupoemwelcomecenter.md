...
The [link](link-win7-microsoft-windows-shell-setupoemwelcomecenterlink.md) setting specifies the complete path and the file name of a shortcut file with a .lnk file-name extension. The path to the shortcut file must refer to a location on the destination computer.
...
<tbody>
<tr class="odd">
<td><p>[link](link-win7-microsoft-windows-shell-setupoemwelcomecenterlink.md)</p></td>
