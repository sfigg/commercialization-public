...
ms.assetid: 3c644e88-3ee1-4c9e-92fc-fd8d37eb7c8a
ms.prod: W10
...
`Link9` specifies the path to the tenth shortcut that appears as a task in the OEM Jump List in the OEM First Run application.
...
<td><p>Specifies the path to the tenth shortcut.</p>
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [OEMWelcomeCenterLinks](oemwelcomecenterlinks-win7-microsoft-windows-shell-setupoemwelcomecenterlinks.md) | **Link9**
