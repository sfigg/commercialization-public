...
`CommandLine` specifies the path to the [SynchronousCommand](synchronouscommand-win7-microsoft-windows-shell-setupfirstlogoncommandssynchronouscommand.md) to be run at first logon.
