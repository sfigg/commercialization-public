...
<td><p>Specifies that the number specified in the [LoadWeight](loadweight-win7-microsoft-windows-networkloadbalancing-coreclustersclusterportrulesportruleloadweight.md) setting is used to increase or decrease the load relative to other nodes in the cluster.</p></td>
</tr>
</tbody>
</table>
...
The following XML output shows how to specify that the number specified in the [LoadWeight](loadweight-win7-microsoft-windows-networkloadbalancing-coreclustersclusterportrulesportruleloadweight.md) setting is used to increase or decrease the load relative to other nodes in the cluster.
