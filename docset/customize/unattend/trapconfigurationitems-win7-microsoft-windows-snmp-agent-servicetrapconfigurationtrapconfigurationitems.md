...
<tr class="even">
<td><p>[Traps](traps-win7-microsoft-windows-snmp-agent-servicetrapconfigurationtrapconfigurationitemstraps.md)</p></td>
...
[Microsoft-Windows-SNMP-Agent-Service](microsoft-windows-snmp-agent-service-win7-microsoft-windows-snmp-agent-service.md) | [TrapConfiguration](trapconfiguration-win7-microsoft-windows-snmp-agent-servicetrapconfiguration.md) | **TrapConfigurationItems**
