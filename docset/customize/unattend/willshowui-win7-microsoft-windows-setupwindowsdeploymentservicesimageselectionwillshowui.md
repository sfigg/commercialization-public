...
`WillShowUI` specifies in what circumstances the user interface (UI) is displayed for [ImageSelection](imageselection-win7-microsoft-windows-setupwindowsdeploymentservicesimageselection.md).
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [WindowsDeploymentServices](windowsdeploymentservices-win7-microsoft-windows-setupwindowsdeploymentservices.md) | [ImageSelection](imageselection-win7-microsoft-windows-setupwindowsdeploymentservicesimageselection.md) | **WillShowUI**
