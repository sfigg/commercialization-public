...
ms.assetid: 1d5c66d7-16b4-4c5b-95bc-85830d7f436e
ms.prod: W10
...
`Link1` specifies the path to the second shortcut that appears as a task in the Jump List of the OEM First Run application.
...
*path* specifies the complete path and the file name of a shortcut file with a .lnk file name extension. The path to the shortcut file must refer to a location on the destination computer.
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [OEMWelcomeCenterLinks](oemwelcomecenterlinks-win7-microsoft-windows-shell-setupoemwelcomecenterlinks.md) | **Link1**
