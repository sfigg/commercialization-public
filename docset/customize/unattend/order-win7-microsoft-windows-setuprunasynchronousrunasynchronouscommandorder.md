...
To run services or commands that can start at the same time, use asynchronous commands. To run commands that need to finish before other commands can start, use [RunSynchronous](runsynchronous-win7-microsoft-windows-setuprunsynchronous.md) commands instead.
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [RunAsynchronous](runasynchronous-win7-microsoft-windows-setuprunasynchronous.md) | [RunAsynchronousCommand](runasynchronouscommand-win7-microsoft-windows-setuprunasynchronousrunasynchronouscommand.md) | **Order**
