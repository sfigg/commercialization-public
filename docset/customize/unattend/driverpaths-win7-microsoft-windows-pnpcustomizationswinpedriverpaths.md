...
<tbody>
<tr class="odd">
<td><p>[PathAndCredentials](pathandcredentials-win7-microsoft-windows-pnpcustomizationswinpedriverpathspathandcredentials.md)</p></td>
<td><p>Specifies a local or Universal Naming Convention (UNC) path to the out-of-box drivers and, optionally, the [Credentials](credentials-win7-microsoft-windows-pnpcustomizationswinpedriverpathspathandcredentialscredentials.md) used to access them.</p></td>
</tr>
</tbody>
</table>
