...
`Size` specifies the size of the extension. If `Size` and [Extend](extend-win7-microsoft-windows-deploymentextendospartitionextend.md) are present in the same configuration pass, an error is logged, and installation terminates.
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [ExtendOSPartition](extendospartition-win7-microsoft-windows-deploymentextendospartition.md) | **Size**
