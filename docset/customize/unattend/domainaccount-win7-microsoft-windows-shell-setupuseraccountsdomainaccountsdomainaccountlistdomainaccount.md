...
<tbody>
<tr class="odd">
<td><p>[Group](group-win7-microsoft-windows-shell-setupuseraccountsdomainaccountsdomainaccountlistdomainaccountgroup.md)</p></td>
<td><p>Specifies the group to which the <code>DomainAccount</code> belongs.</p></td>
</tr>
<tr class="even">
<td><p>[Name](name-win7-microsoft-windows-shell-setupuseraccountsdomainaccountsdomainaccountlistdomainaccountname.md)</p></td>
