...
`Profile` specifies the profile of a [FirewallGroup](firewallgroup-win7-networking-mpssvc-svcfirewallgroupsfirewallgroup.md).
...
[Networking-MPSSVC-Svc](networking-mpssvc-svc-win7-networking-mpssvc-svc.md) | [FirewallGroups](firewallgroups-win7-networking-mpssvc-svcfirewallgroups.md) | [FirewallGroup](firewallgroup-win7-networking-mpssvc-svcfirewallgroupsfirewallgroup.md) | **Profile**
...
For the list of the supported Windows editions and architectures that this component supports, see [Networking-MPSSVC-Svc](networking-mpssvc-svc-win7-networking-mpssvc-svc.md).
