...
`Credentials` is an optional setting that is used to access the Universal Naming Convention (UNC) path specified by the [Path](path-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialspath.md).
...
<tbody>
<tr class="odd">
<td><p>[Domain](domain-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialscredentialsdomain.md)</p></td>
...
<tr class="even">
<td><p>[Password](password-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialscredentialspassword.md)</p></td>
<td><p>Specifies the password of the account to use for authentication.</p></td>
</tr>
<tr class="odd">
<td><p>[Username](username-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialscredentialsusername.md)</p></td>
...
[Microsoft-Windows-PnpCustomizationsNonWinPE](microsoft-windows-pnpcustomizationsnonwinpe-win7-microsoft-windows-pnpcustomizationsnonwinpe.md) | [DriverPaths](driverpaths-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpaths.md) | [PathAndCredentials](pathandcredentials-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentials.md) | **Credentials**
