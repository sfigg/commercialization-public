...
**Note**  
The settings in Interface must be added in the following order: [Ipv4Settings](ipv4settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv4settings.md), [Ipv6Settings](ipv6settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv6settings.md), [Identifier](identifier-win7-microsoft-windows-tcpipinterfacesinterfaceidentifier.md), [UnicastIpAddresses](unicastipaddresses-win7-microsoft-windows-tcpipinterfacesinterfaceunicastipaddresses.md), and then [Routes](routes-win7-microsoft-windows-tcpipinterfacesinterfaceroutes.md). After saving your Unattend file in Windows SIM, verify in the XML file that the output is shown in the correct order, as shown in the XML example below.
...
<tbody>
<tr class="odd">
<td><p>[Identifier](identifier-win7-microsoft-windows-tcpipinterfacesinterfaceidentifier.md)</p></td>
<td><p>Specifies the interface to apply to the other settings within <code>Interface</code>.</p></td>
</tr>
<tr class="even">
<td><p>[Ipv4Settings](ipv4settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv4settings.md)</p></td>
<td><p>Specifies settings for the IP version 4 interface.</p></td>
</tr>
<tr class="odd">
<td><p>[Ipv6Settings](ipv6settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv6settings.md)</p></td>
<td><p>Specifies settings for the IP version 6 interface.</p></td>
</tr>
<tr class="even">
<td><p>[Routes](routes-win7-microsoft-windows-tcpipinterfacesinterfaceroutes.md)</p></td>
<td><p>Specifies the IPv4 and IPv6 routes.</p></td>
</tr>
<tr class="odd">
<td><p>[UnicastIpAddresses](unicastipaddresses-win7-microsoft-windows-tcpipinterfacesinterfaceunicastipaddresses.md)</p></td>
...
[Microsoft-Windows-TCPIP](microsoft-windows-tcpip-win7-microsoft-windows-tcpip.md) | [Interfaces](interfaces-win7-microsoft-windows-tcpipinterfaces.md) | **Interface**
