...
`Identifier` specifies the interface to apply to the other settings within [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md). It can be expressed in any one of the following ways:
...
**Note**  
The settings in [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md) must be added in the following order: [Ipv4Settings](ipv4settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv4settings.md), [Ipv6Settings](ipv6settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv6settings.md), Identifier, [UnicastIpAddresses](unicastipaddresses-win7-microsoft-windows-tcpipinterfacesinterfaceunicastipaddresses.md), and then [Routes](routes-win7-microsoft-windows-tcpipinterfacesinterfaceroutes.md). After saving your Unattend file in Windows SIM, verify in the XML file that the output is shown in the correct order, as shown in the XML example below.
...
[Microsoft-Windows-TCPIP](microsoft-windows-tcpip-win7-microsoft-windows-tcpip.md) | [Interfaces](interfaces-win7-microsoft-windows-tcpipinterfaces.md) | [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md) | **Identifier**
