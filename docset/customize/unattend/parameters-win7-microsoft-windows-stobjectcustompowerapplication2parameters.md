...
`Parameters` specifies the arguments to add to [CustomPowerApplication2](custompowerapplication2-win7-microsoft-windows-stobjectcustompowerapplication2.md).
...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication2](custompowerapplication2-win7-microsoft-windows-stobjectcustompowerapplication2.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication2](custompowerapplication2-win7-microsoft-windows-stobjectcustompowerapplication2.md) | **Parameters**
