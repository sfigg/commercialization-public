...
`Description` describes the synchronous command to run specified by [Path](path-win7-microsoft-windows-setuprunsynchronousrunsynchronouscommandpath.md).
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [RunSynchronous](runsynchronous-win7-microsoft-windows-setuprunsynchronous.md) | [RunSynchronousCommand](runsynchronouscommand-win7-microsoft-windows-setuprunsynchronousrunsynchronouscommand.md) | **Description**
