...
ms.assetid: 2741f310-26a7-4323-ae80-37d9605d1c52
ms.prod: W10
...
`Link5` specifies the path to the sixth shortcut that appears as a link in the Jump List in the OEM First Run application.
...
<td><p>Specifies the path to the sixth shortcut.</p>
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [OEMWelcomeCenterLinks](oemwelcomecenterlinks-win7-microsoft-windows-shell-setupoemwelcomecenterlinks.md) | **Link5**
