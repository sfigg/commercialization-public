...
[RunSynchronous](runsynchronous-win7-microsoft-windows-deploymentrunsynchronous.md) commands run in the user context in the auditUser configuration pass and in the system context in the specialize pass.
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [RunSynchronous](runsynchronous-win7-microsoft-windows-deploymentrunsynchronous.md) | [RunSynchronousCommand](runsynchronouscommand-win7-microsoft-windows-deploymentrunsynchronousrunsynchronouscommand.md) | **WillReboot**
