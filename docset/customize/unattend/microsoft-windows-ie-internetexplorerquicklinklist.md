...
`QuickLinkList` is a container for [QuickLinkItem](microsoft-windows-ie-internetexplorerquicklinklistquicklinkitem.md) settings.
...
<tbody>
<tr class="odd">
<td><p>[QuickLinkItem](microsoft-windows-ie-internetexplorerquicklinklistquicklinkitem.md)</p></td>
