...
`WillShowUI` specifies in what circumstances to display the user interface (UI) when applying a product key specified by [ProductKey](productkey-win7-microsoft-windows-setupuserdataproductkey.md).
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [UserData](userdata-win7-microsoft-windows-setupuserdata.md) | [ProductKey](productkey-win7-microsoft-windows-setupuserdataproductkey.md) | **WillShowUI**
