...
`IconID` specifies the full path to the resource DLL that contains the icon to use with [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md).
...
<tr class="odd">
<td><p><em>ID</em></p></td>
<td><p>Specifies the resource ID of the icon to use for [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication5](custompowerapplication5-win7-microsoft-windows-stobjectcustompowerapplication5.md) | **IconID**
