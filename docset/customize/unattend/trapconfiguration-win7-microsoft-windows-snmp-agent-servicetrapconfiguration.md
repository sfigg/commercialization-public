...
<tbody>
<tr class="odd">
<td><p>[TrapConfigurationItems](trapconfigurationitems-win7-microsoft-windows-snmp-agent-servicetrapconfigurationtrapconfigurationitems.md)</p></td>
...
[Microsoft-Windows-SNMP-Agent-Service](microsoft-windows-snmp-agent-service-win7-microsoft-windows-snmp-agent-service.md) | **TrapConfiguration**
