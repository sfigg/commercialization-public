...
<p>If [WillShowUI](willshowui-win7-microsoft-windows-setupdiskconfigurationwillshowui.md) is set to <strong>Never</strong> and an invalid <code>PartitionID</code> setting is specified, an error is logged and installation terminates.</p></td>
</tr>
</tbody>
</table>
...
For a list of the supported Microsoft Windows editions and architectures that this component supports, see [Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md).
