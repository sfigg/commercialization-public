...
`UserName` specifies the user name of the account used to authenticate access to the location specified by [Path](path-win7-microsoft-windows-setuprunsynchronousrunsynchronouscommandpath.md).
