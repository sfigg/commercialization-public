...
`Parameters` specifies the arguments to add to [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md).
...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md) | **Parameters**
