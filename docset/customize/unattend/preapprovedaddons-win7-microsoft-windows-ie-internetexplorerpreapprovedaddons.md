...
`PreapprovedAddons` can contain one or more [AddonGuidItem](addonguiditem-win7-microsoft-windows-ie-internetexplorerpreapprovedaddonsaddonguiditem.md) settings each of which represents a single add-on module.
...
<tbody>
<tr class="odd">
<td><p>[AddonGuidItem](addonguiditem-win7-microsoft-windows-ie-internetexplorerpreapprovedaddonsaddonguiditem.md)</p></td>
