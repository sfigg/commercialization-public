...
`MustReboot` specifies whether to restart the computer immediately after setting it to audit mode [Name](name-win7-microsoft-windows-deploymentauditcomputernamename.md).
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [AuditComputerName](auditcomputername-win7-microsoft-windows-deploymentauditcomputername.md) | **MustReboot**
