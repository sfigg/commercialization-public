...
`QuickLinkName` specifies a friendly name for the [QuickLinkItem](quicklinkitem-win7-microsoft-windows-ie-internetexplorerquicklinklistquicklinkitem.md), as it appears on the **Favorites** toolbar.
