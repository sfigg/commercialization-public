...
`Username` specifies the name of the account used to authenticate the [Path](path-win7-microsoft-windows-pnpcustomizationswinpedriverpathspathandcredentialspath.md).
