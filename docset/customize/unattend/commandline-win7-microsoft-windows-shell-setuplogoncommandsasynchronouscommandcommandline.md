...
`CommandLine` specifies the path to the [AsynchronousCommand](asynchronouscommand-win7-microsoft-windows-shell-setuplogoncommandsasynchronouscommand.md) to be run.
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [LogonCommands](logoncommands-win7-microsoft-windows-shell-setuplogoncommands.md) | [AsynchronousCommand](asynchronouscommand-win7-microsoft-windows-shell-setuplogoncommandsasynchronouscommand.md) | **CommandLine**
