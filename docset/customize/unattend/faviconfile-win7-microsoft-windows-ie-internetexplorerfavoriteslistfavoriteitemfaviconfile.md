...
`FavIconFile` specifies the icon to associate with the [FavoriteItem](favoriteitem-win7-microsoft-windows-ie-internetexplorerfavoriteslistfavoriteitem.md) in the Favorites folder.
...
<td><p>Specifies the location and the name of the icon to associate with the [FavoriteItem](favoriteitem-win7-microsoft-windows-ie-internetexplorerfavoriteslistfavoriteitem.md) in the Favorites folder, for example, C:\Windows\favlink2.ico. <em>Path_and_file_name</em> is a string.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-IE-InternetExplorer](microsoft-windows-ie-internetexplorer-win7-microsoft-windows-ie-internetexplorer.md) | [FavoritesList](favoriteslist-win7-microsoft-windows-ie-internetexplorerfavoriteslist.md) | [FavoriteItem](favoriteitem-win7-microsoft-windows-ie-internetexplorerfavoriteslistfavoriteitem.md) | **FavIconFile**
