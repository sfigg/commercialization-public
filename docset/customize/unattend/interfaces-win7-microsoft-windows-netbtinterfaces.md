...
`Interfaces` serves as a container for groups of [Interface](interface-win7-microsoft-windows-netbtinterfacesinterface.md)-specific settings.
...
<tbody>
<tr class="odd">
<td><p>[Interface](interface-win7-microsoft-windows-netbtinterfacesinterface.md)</p></td>
