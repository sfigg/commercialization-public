...
<tbody>
<tr class="odd">
<td><p>[Credentials](credentials-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialscredentials.md)</p></td>
<td><p>Specifies the credentials (optional) used to access the path specified by the [Path](path-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialspath.md).</p></td>
</tr>
<tr class="even">
<td><p>[Key](key-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialskey.md)</p></td>
<td><p>Specifies a unique string identifier for the driver path.</p></td>
</tr>
<tr class="odd">
<td><p>[Path](path-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialspath.md)</p></td>
...
[Microsoft-Windows-PnpCustomizationsNonWinPE](microsoft-windows-pnpcustomizationsnonwinpe-win7-microsoft-windows-pnpcustomizationsnonwinpe.md) | [DriverPaths](driverpaths-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpaths.md) | **PathAndCredentials**
