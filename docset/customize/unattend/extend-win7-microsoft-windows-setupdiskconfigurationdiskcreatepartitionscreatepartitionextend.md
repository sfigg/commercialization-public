...
<td><p>Specifies that the newly-created partition is a fixed size, as specified by <code>CreatePartition:</code>[Size](size-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitionsize.md). This is the default value.</p></td>
</tr>
</tbody>
</table>
...
When creating a new partition, you must either use `CreatePartition:`[Size](size-win7-microsoft-windows-setupdiskconfigurationdiskcreatepartitionscreatepartitionsize.md), or set `CreatePartition:Extend` to true.
