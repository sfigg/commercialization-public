...
`Description` specifies a description of a [LocalAccount](localaccount-win7-microsoft-windows-shell-setupuseraccountslocalaccountslocalaccount.md) to be created during installation.
...
<td><p>Specifies a description of a [LocalAccount](localaccount-win7-microsoft-windows-shell-setupuseraccountslocalaccountslocalaccount.md). <em>Description</em> is a string with a maximum length of 256 characters.</p></td>
</tr>
</tbody>
</table>
