...
<tbody>
<tr class="odd">
<td><p>[Logo](logo-win8-microsoft-windows-helpandsupporthelpandsupportlogo.md)</p></td>
<td><p>Specifies the path of an image file that contains the logo of the OEM or organization.</p></td>
</tr>
<tr class="even">
<td><p>[LogoURL](logourl-win8-microsoft-windows-helpandsupporthelpandsupportlogourl.md)</p></td>
<td><p>Specifies the URL for a support page for the OEM or organization.</p></td>
</tr>
<tr class="odd">
<td><p>[Manufacturer](manufacturer-win8-microsoft-windows-helpandsupporthelpandsupportmanufacturer.md)</p></td>
<td><p>Specifies the name of the OEM.</p></td>
</tr>
<tr class="even">
<td><p>[SearchContent](searchcontent-win8-microsoft-windows-helpandsupporthelpandsupportsearchcontent.md)</p></td>
...
<tr class="odd">
<td><p>[SupportSearchURL](supportsearchurl-win8-microsoft-windows-helpandsupporthelpandsupportsupportsearchurl.md)</p></td>
<td><p>Specifies the URL that the system uses to display a search link on the page of search results.</p></td>
</tr>
<tr class="even">
<td><p>[TileColor](tilecolor-win8-microsoft-windows-helpandsupporthelpandsupporttilecolor.md)</p></td>
