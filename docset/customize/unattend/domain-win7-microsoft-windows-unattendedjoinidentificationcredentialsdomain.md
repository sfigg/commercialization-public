...
<p>If a value for <code>Domain</code> is not specified, [Username](username-win7-microsoft-windows-unattendedjoinidentificationcredentialsusername.md) must use the user principal name (UPN) format (user@fully-qualified-DNS-domain), NetBIOS-domain\username format, or the fully-qualified-DNS-domain\username format.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-UnattendedJoin](microsoft-windows-unattendedjoin-win7-microsoft-windows-unattendedjoin.md) | [Identification](identification-win7-microsoft-windows-unattendedjoinidentification.md) | [Credentials](credentials-win7-microsoft-windows-unattendedjoinidentificationcredentials.md) | **Domain**
