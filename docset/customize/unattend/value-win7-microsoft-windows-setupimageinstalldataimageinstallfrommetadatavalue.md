...
`Value` specifies the value for the [Key](key-win7-microsoft-windows-setupimageinstalldataimageinstallfrommetadatakey.md) setting. For information about using this setting, see [MetaData](metadata-win7-microsoft-windows-setupimageinstalldataimageinstallfrommetadata.md).
