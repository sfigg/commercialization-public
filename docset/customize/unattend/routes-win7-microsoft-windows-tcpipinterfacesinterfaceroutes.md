...
**Note**  
The settings in [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md) must be added in the following order: [Ipv4Settings](ipv4settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv4settings.md), [Ipv6Settings](ipv6settings-win7-microsoft-windows-tcpipinterfacesinterfaceipv6settings.md), [Identifier](identifier-win7-microsoft-windows-tcpipinterfacesinterfaceidentifier.md), [UnicastIpAddresses](unicastipaddresses-win7-microsoft-windows-tcpipinterfacesinterfaceunicastipaddresses.md), and then Routes. After saving your Unattend file in Windows SIM, verify in the XML file that the output is shown in the correct order, as shown in the XML example below.
...
<tbody>
<tr class="odd">
<td><p>[Route](route-win7-microsoft-windows-tcpipinterfacesinterfaceroutesroute.md)</p></td>
...
[Microsoft-Windows-TCPIP](microsoft-windows-tcpip-win7-microsoft-windows-tcpip.md) | [Interfaces](interfaces-win7-microsoft-windows-tcpipinterfaces.md) | [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md) | **Routes**
