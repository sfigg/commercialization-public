...
`PartitionID` specifies the Partition ID that identifies the Microsoft® ReadyBoost™ device. This value is used with [DiskID](diskid-win7-microsoft-windows-systemmaintenanceservicecachelistcachediskid.md).
