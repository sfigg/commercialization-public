...
When `DisableAccelerators` is set to **false**, Accelerators set through [Accelerators](accelerators-win7-microsoft-windows-ie-internetexploreraccelerators.md) are also disabled.
...
[Microsoft-Windows-IE-InternetExplorer](microsoft-windows-ie-internetexplorer-win7-microsoft-windows-ie-internetexplorer.md) | **DisableAccelerators**
