...
`Parameters` specifies the arguments to add to [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md).
...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md) | **Parameters**
