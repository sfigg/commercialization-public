...
The `Group` setting specifies the name of a [FirewallGroup](firewallgroup-win7-networking-mpssvc-svcfirewallgroupsfirewallgroup.md). The available rule groups differ by Windows® edition.
...
[Networking-MPSSVC-Svc](networking-mpssvc-svc-win7-networking-mpssvc-svc.md) | [FirewallGroups](firewallgroups-win7-networking-mpssvc-svcfirewallgroups.md) | [FirewallGroup](firewallgroup-win7-networking-mpssvc-svcfirewallgroupsfirewallgroup.md) | **Group**
