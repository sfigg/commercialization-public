...
`ItemName` is the display name of [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md)
...
<td><p>Specifies the display name to use for [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication3](custompowerapplication3-win7-microsoft-windows-stobjectcustompowerapplication3.md) | **ItemName**
