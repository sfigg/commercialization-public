...
The `ColorDepth` setting is used to configure only Windows® PE, and is not applied to the Windows installation. To change the display settings for the Windows installation, see [Display](display-win7-microsoft-windows-shell-setupdisplay.md) in the [Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) component.
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [Display](display-win7-microsoft-windows-setupdisplay.md) | **ColorDepth**
