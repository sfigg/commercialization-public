...
<tbody>
<tr class="odd">
<td><p>[BTSearchIntervalOnAC](btsearchintervalonac-win7-microsoft-windows-wpd-busenumservicebtsearchintervalonac.md)</p></td>
<td><p>Specifies how often the computer will search for portable devices using MTP/BT while plugged in to AC power.</p></td>
</tr>
<tr class="even">
<td><p>[BTSearchIntervalOnDC](btsearchintervalondc-win7-microsoft-windows-wpd-busenumservicebtsearchintervalondc.md)</p></td>
<td><p>Specifies how often the computer will search for portable devices using MTP/BT while on battery power.</p></td>
</tr>
<tr class="odd">
<td><p>[RegCacheUpdated](regcacheupdated-win7-microsoft-windows-wpd-busenumserviceregcacheupdated.md)</p></td>
