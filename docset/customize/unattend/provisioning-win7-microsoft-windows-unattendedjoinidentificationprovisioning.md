...
**Note**  
Use either Provisioning or [Credentials](credentials-win7-microsoft-windows-unattendedjoinidentificationcredentials.md) to join an account to the domain. The settings in Provisioning will be used to join the account to the domain, if values are entered for both the Provisioning and Credentials settings.
...
<tbody>
<tr class="odd">
<td><p>[AccountData](accountdata-win7-microsoft-windows-unattendjoinidentificationprovisioningaccountdata.md)</p></td>
...
[Microsoft-Windows-UnattendedJoin](microsoft-windows-unattendedjoin-win7-microsoft-windows-unattendedjoin.md) | [Identification](identification-win7-microsoft-windows-unattendedjoinidentification.md) | **Provisioning**
