...
<td><p>Specifies the name of the computer. If you do not specify a name and the [MustReboot](microsoft-windows-deploymentauditcomputernamemustreboot.md) setting is present, this setting is ignored. The <em>name</em> value is a string with a maximum length of 15 characters.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [AuditComputerName](microsoft-windows-deploymentauditcomputername.md) | **Name**
