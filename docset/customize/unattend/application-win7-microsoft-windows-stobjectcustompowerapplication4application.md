...
`Application` specifies the full path to the application specified by [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md).
...
<td><p>Specifies the full path and the executable file name for [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md). For example,</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication4](custompowerapplication4-win7-microsoft-windows-stobjectcustompowerapplication4.md) | **Application**
