...
`WillShowUI` specifies in what circumstances the user interface (UI) is displayed for [UpgradeData](upgradedata-win7-microsoft-windows-setupupgradedata.md).
...
[Microsoft-Windows-Setup](microsoft-windows-setup-win7-microsoft-windows-setup.md) | [UpgradeData](upgradedata-win7-microsoft-windows-setupupgradedata.md) | **WillShowUI**
