...
<td><p>Specifies the domain name or the computer name of the account used to authenticate the [Path](path-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialspath.md).</p>
