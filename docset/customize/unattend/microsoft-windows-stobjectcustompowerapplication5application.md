...
`Application` specifies the full path to the application specified by [CustomPowerApplication5](microsoft-windows-stobjectcustompowerapplication5.md).
...
<td><p>Specifies the full path and the executable file name for [CustomPowerApplication5](microsoft-windows-stobjectcustompowerapplication5.md). For example,</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication5](microsoft-windows-stobjectcustompowerapplication5.md) | **Application**
