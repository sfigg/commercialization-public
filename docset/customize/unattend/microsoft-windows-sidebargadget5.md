...
ms.assetid: 4dd321c1-224f-45a0-ad21-d597ce3f2fbf
ms.prod: W10
...
`Gadget5` specifies the path of a gadget (.gadget) folder. The gadget folder has a .gadget extension.
...
<td><p>Specifies the path of a .gadget folder. <em>Path_to_gadget</em> is a string.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-Sidebar](microsoft-windows-sidebar-win7-microsoft-windows-sidebar.md) | **Gadget5**
