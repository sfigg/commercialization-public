...
`Domain` specifies the domain of the account used for authentication to access the data image specified by [InstallFrom](microsoft-windows-setup-imageinstalldataimageinstallfrom.md).
