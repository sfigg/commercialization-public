...
`ItemName` is the display name of [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md).
...
<td><p>Specifies the display name to use for [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md) | **ItemName**
