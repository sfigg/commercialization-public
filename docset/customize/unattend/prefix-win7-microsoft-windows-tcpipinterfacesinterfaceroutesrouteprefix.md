...
-   **As a string.**
    ...
    When Prefix is set as a string, you do not need to set the [NextHopAddress](nexthopaddress-win7-microsoft-windows-tcpipinterfacesinterfaceroutesroutenexthopaddress.md) value.
...
[Microsoft-Windows-TCPIP](microsoft-windows-tcpip-win7-microsoft-windows-tcpip.md) | [Interfaces](interfaces-win7-microsoft-windows-tcpipinterfaces.md) | [Interface](interface-win7-microsoft-windows-tcpipinterfacesinterface.md) | [Routes](routes-win7-microsoft-windows-tcpipinterfacesinterfaceroutes.md) | [Route](route-win7-microsoft-windows-tcpipinterfacesinterfaceroutesroute.md) | **Prefix**
