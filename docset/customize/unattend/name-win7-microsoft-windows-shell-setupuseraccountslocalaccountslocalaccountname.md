...
`Name` specifies the user name for a [LocalAccount](localaccount-win7-microsoft-windows-shell-setupuseraccountslocalaccountslocalaccount.md) to be created during installation.
...
<td><p>Specifies the name of a [LocalAccount](localaccount-win7-microsoft-windows-shell-setupuseraccountslocalaccountslocalaccount.md). <em>Name</em> is a string with a maximum length of 256 characters.</p>
