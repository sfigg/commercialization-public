...
`Mode` is used with the [ForceShutdownNow](forceshutdownnow-win7-microsoft-windows-deploymentresealforceshutdownnow.md) setting to indicate whether the computer starts in audit mode or Out-of-Box-Experience (OOBE). For more information about modes, see the [Configuration Passes](http://go.microsoft.com/fwlink/?LinkId=268344) topic.
...
[Microsoft-Windows-Deployment](microsoft-windows-deployment-win7-microsoft-windows-deployment.md) | [Reseal](reseal-win7-microsoft-windows-deploymentreseal.md) | **Mode**
