...
`JoinDomain` specifies the name of the domain to join. If this value is set, [JoinWorkgroup](joinworkgroup-win7-microsoft-windows-unattendedjoinidentificationjoinworkgroup.md) cannot be set.
...
[Microsoft-Windows-UnattendedJoin](microsoft-windows-unattendedjoin-win7-microsoft-windows-unattendedjoin.md) | [Identification](identification-win7-microsoft-windows-unattendedjoinidentification.md) | **JoinDomain**
