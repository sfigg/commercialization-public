...
`Parameters` specifies the arguments to add to [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md).
...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication6](custompowerapplication6-win7-microsoft-windows-stobjectcustompowerapplication6.md) | **Parameters**
