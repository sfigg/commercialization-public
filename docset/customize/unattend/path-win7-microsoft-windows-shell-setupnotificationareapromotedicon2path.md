...
By setting the **Path** and [GUID](guid-win7-microsoft-windows-shell-setupnotificationareapromotedicon2guid.md) elements of the **PromotedIcon2** component, you can configure another icon to be visible in the notification area. This icon will appear in place of the **Battery** icon.
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [NotificationArea](notificationarea-win7-microsoft-windows-shell-setupnotificationarea.md) | [PromotedIcon2](promotedicon2-win7-microsoft-windows-shell-setupnotificationareapromotedicon2.md) | **Path**
