...
`Parameters` specifies the arguments to add to [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md).
...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md).</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md) | **Parameters**
