...
<tbody>
<tr class="odd">
<td><p>[AppId](appid-win8-microsoft-windows-shell-setupstarttileslockscreenbadgeappid.md)</p></td>
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md)| [StartTiles](starttiles-win8-microsoft-windows-shell-setupstarttiles.md) | [LockScreen](lockscreen-win8-microsoft-windows-shell-setupstarttileslockscreen.md) | **Badge**
...
The following XML output shows how to set [LockScreen](lockscreen-win8-microsoft-windows-shell-setupstarttileslockscreen.md).
