...
ms.assetid: ffc4094b-40d1-487f-bd01-cebb9c83afae
ms.prod: W10
...
`Link0` specifies the path to the first shortcut that appears as a task in the Jump List in the OEM First Run application.
...
<td><p>Specifies the path to the first shortcut.</p>
...
<p>Each shortcut file must include the complete path of a corresponding program, Web page, or document.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup-win7-microsoft-windows-shell-setup.md) | [OEMWelcomeCenterLinks](oemwelcomecenterlinks-win7-microsoft-windows-shell-setupoemwelcomecenterlinks.md) | **Link0**
