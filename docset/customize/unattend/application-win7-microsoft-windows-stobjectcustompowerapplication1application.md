...
`Application` specifies the full path to the application specified by [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md).
...
<td><p>Specifies the full path and the executable file name for [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md). For example,</p>
...
[Microsoft-Windows-stobject](microsoft-windows-stobject-win7-microsoft-windows-stobject.md) | [CustomPowerApplication1](custompowerapplication1-win7-microsoft-windows-stobjectcustompowerapplication1.md) | **Application**
