...
<tbody>
<tr class="odd">
<td><p>[ArchiveFaxes](archivefaxes-win7-microsoft-windows-fax-servicefaxarchivefaxes.md)</p></td>
<td><p>Specifies whether to save all incoming and outgoing faxes in a folder.</p></td>
</tr>
<tr class="even">
<td><p>[ArchiveFolderName](archivefoldername-win7-microsoft-windows-fax-servicefaxarchivefoldername.md)</p></td>
<td><p>Specifies the folder in which the fax service saves copies of all incoming and outgoing faxes.</p></td>
</tr>
<tr class="odd">
<td><p>[IncomingFaxesArePublic](incomingfaxesarepublic-win7-microsoft-windows-fax-servicefaxincomingfaxesarepublic.md)</p></td>
...
[Microsoft-Windows-Fax-Service](microsoft-windows-fax-service-win7-microsoft-windows-fax-service.md) | **Fax**
