...
<p>The value for <em>Username</em> can be in user principal name (UPN) format (user@fully_qualified_DNS_domain_name), domain\username format, or fully-qualified-DNS-domain\username format. If any of these formats is specified, the [Domain](domain-win7-microsoft-windows-unattendedjoinidentificationcredentialsdomain.md) setting must be excluded.</p></td>
</tr>
</tbody>
</table>
...
[Microsoft-Windows-UnattendedJoin](microsoft-windows-unattendedjoin-win7-microsoft-windows-unattendedjoin.md) | [Identification](identification-win7-microsoft-windows-unattendedjoinidentification.md) | [Credentials](credentials-win7-microsoft-windows-unattendedjoinidentificationcredentials.md) | **Username**
