...
<td><p>Specifies the user name of the account used to authenticate the [Path](path-win7-microsoft-windows-pnpcustomizationsnonwinpedriverpathspathandcredentialspath.md).</p>
