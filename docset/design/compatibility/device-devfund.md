...
<th>Exceptions</th>
<td>
<p>This is a requirement for Windows v10.0 Mobile (ARM, ARM64, x86), but recommended for Windows v10.0 Client (x64, x86) and Windows v10.0 Server x64. It will be required in the future for those architectures.</p>
</tr>
</table>
