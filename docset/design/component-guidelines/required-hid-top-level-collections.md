...
X and Y report the coordinates of the integrated pen.

The following global items should be specified for both the X and Y usages:
...
X-Tilt represents the plane angle between the Y-Z plane and the plane containing the pen transducer axis and the Y axis.

The physical range and logical range must be specified. The physical range must be -90 to 90 deg from vertical. The logical range must be large enough to deliver data that is accurate to at least two decimal places. Radians can also be used for the physical range.

*Y-Tilt*

Y-Tilt represents the plane angle between the X-Z plane and the plane containing the pen transducer axis and the Y axis. The physical range and logical range must be specified.

The physical range must be -90 to 90 deg from vertical. The logical range must be large enough to deliver data that is accurate to at least two decimal places. Radians can also be used for the physical range.
