...
<tbody>
<tr class="odd">
<td><p>[Minimum hardware requirements](minimum-hardware-requirements-overview.md)</p></td>
<td><p>This topic defines the minimum hardware requirements for Windows 10 and all types of devices or computers designed for this release.</p></td>
</tr>
<tr class="even">
...
<td><p>This topic covers recommendations for Bluetooth in Windows 10.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p>[General Purpose Input/Output (GPIO)](general-purpose-input-output--gpio-.md)</p></td>
<td><p>This topic covers recommendations for General Purpose Input/Output (GPIO) in Windows 10.</p></td>
</tr>
<tr class="even">
