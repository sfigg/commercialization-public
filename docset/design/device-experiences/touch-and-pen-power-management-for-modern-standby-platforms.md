...
For more information about power management for touch controllers and pen digitizers, see [Power handling for Windows 8 and Windows 8.1 touch and pen controllers](hw_design.power_handling_for_touch_and_pen_controllers).
