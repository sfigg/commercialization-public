...
If you are unsure if your device correctly implements [ConvertibleSlateMode](../../customize/unattend/convertibleslatemode-win8-microsoft-windowsgpiobuttonsconvertibleslatemode.md), check if the “GPIO Laptop or Slate Indicator Driver” exists in the Device Manager.
...
-   **Hardware action triggered** - The OS can ask the user if they would like to enter/exit “tablet mode” if the hardware has indicated the form factor has changed through [ConvertibleSlateMode](../../customize/unattend/convertibleslatemode-win8-microsoft-windowsgpiobuttonsconvertibleslatemode.md).
