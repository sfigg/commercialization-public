...
-   If Settings is accessible, click ** Settings ** &gt; ** Update & security ** &gt; ** Recovery ** &gt; under Reset this PC, click ** Get started **.
-   Select either ** Keep my files ** to repair the PC, or ** Remove everything ** to prepare the PC for a new user.
...
For PCs, there isn't a way built into Windows that allows you to reset a device remotely. However, you can use third-party programs to do this.
