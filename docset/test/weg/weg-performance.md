...
<!-- The following TOC was produced by Pandoc. I'm not sure if we'll keep any part of it.
# Contents

[Introduction 7](#introduction)

[Document updates 7](#document-updates)

[Delivering a great experience with low memory 8](#delivering-a-great-experience-with-low-memory)

[Considerations 8](#considerations)

[Drivers and apps 8](#drivers-and-apps)

[Overall baseline memory footprint 8](#overall-baseline-memory-footprint)

[Storage 9](#storage)

[Disk performance: 9](#disk-performance)

[Disk endurance 9](#disk-endurance)

[Recommended goals 10](#recommended-goals)

[Measuring memory using the Windows Assessment and Deployment Kit (ADK) 11](#measuring-memory-using-the-windows-assessment-and-deployment-kit-adk)

[Related resources 11](#related-resources)

[Guidance 11](#guidance)

[For OEM 11](#for-oem)

[For IHV/ISV 12](#for-ihvisv)

[For antimalware app ISV 12](#for-antimalware-app-isv)

[Validation 13](#validation)

[System level 13](#_Toc426441276)

[Per driver 14](#per-driver)

[Non-Paged code 14](#non-paged-code)

[Non-Paged allocations 15](#non-paged-allocations)

[Per process 15](#_Toc426441280)

[Delivering a great startup and shutdown experience 16](#_Toc426441281)

[Considerations 16](#considerations-1)

[Fast startup 17](#fast-startup)

[Full boot 18](#full-boot)

[Shutdown API behavior 19](#shutdown-api-behavior)

[Distinguishing when a hibernate or a shutdown for fast startup will occur 19](#distinguishing-when-a-hibernate-or-a-shutdown-for-fast-startup-will-occur)

[Hibernate (S4) suspend and resume 20](#hibernate-s4-suspend-and-resume)

[User scenarios for hibernate 20](#user-scenarios-for-hibernate)

[Hibernate phase 21](#hibernate-phase)

[Resume phase 21](#resume-phase)

[Firmware POST 22](#firmware-post)

[Security (SEC) 23](#security-sec)

[Pre-EFI Initialization (PEI) 23](#pre-efi-initialization-pei)

[Driver Execution Environment (DXE) 23](#driver-execution-environment-dxe)

[Boot Device Selection (BDS) 24](#boot-device-selection-bds)

[USB Enumeration 24](#usb-enumeration)

[Apps 24](#apps)

[Recommended goals 25](#recommended-goals-1)

[Validation and testing 26](#validation-and-testing)

[Tools and technical reference 26](#tools-and-technical-reference)

[Delivering a great browsing experience 27](#delivering-a-great-browsing-experience)

[Considerations 27](#considerations-2)

[How antimalware apps affect browsing 27](#how-antimalware-apps-affect-browsing)

[Selecting antimalware apps 28](#selecting-antimalware-apps)

[Recommended goals 28](#recommended-goals-2)

[Validation and testing 29](#validation-and-testing-1)

[Internet Explorer Security Software Impact assessment 29](#internet-explorer-security-software-impact-assessment)

[Delivering a great media experience 30](#delivering-a-great-media-experience)

[Considerations 30](#considerations-3)

[Recommended goals 33](#recommended-goals-3)

[Validation and testing 33](#validation-and-testing-2)

[Analyzing audio and video glitches 35](#analyzing-audio-and-video-glitches)

[Tools and technical reference 38](#tools-and-technical-reference-1)

[Delivering a great app experience 40](#delivering-a-great-app-experience)

[Building fast, fluid, and power-efficient Windows Store apps 40](#building-fast-fluid-and-power-efficient-windows-store-apps)

[Tools and technical reference 40](#tools-and-technical-reference-2)

[Analyzing Windows Store apps performance with the ADK 44](#analyzing-windows-store-apps-performance-with-the-adk)

[Delivering an image with high quality Windows Store apps 45](#delivering-an-image-with-high-quality-windows-store-apps)

[Recommended goals 45](#recommended-goals-4)

[Validation and testing 45](#validation-and-testing-3)

[Tools and technical reference 46](#tools-and-technical-reference-3)

[Delivering a great energy efficiency experience with Modern Standby 46](#delivering-a-great-energy-efficiency-experience-with-modern-standby)

[Considerations 48](#considerations-4)

[Recommended goals 50](#recommended-goals-5)

[Validation and testing 50](#validation-and-testing-4)

[Generating a report on battery life estimates and history by using PowerCfg.exe 50](#generating-a-report-on-battery-life-estimates-and-history-by-using-powercfg.exe)

[Generating a report on Modern Standby issues by using SleepStudy 51](#generating-a-report-on-modern-standby-issues-by-using-sleepstudy)

[Automating connected standby testing by using PwrTest.exe 54](#automating-connected-standby-testing-by-using-pwrtest.exe)

[Delivering a great energy efficiency experience 55](#delivering-a-great-energy-efficiency-experience)

[Considerations 55](#considerations-5)

[Recommended goals 56](#recommended-goals-6)

[Validation and testing 56](#validation-and-testing-5)

[Configure your PC for testing 57](#configure-your-pc-for-testing)

[Tools and technical reference 59](#tools-and-technical-reference-4)

[Instrumenting Your Code with ETW 62](#instrumenting-your-code-with-etw)

[Overview 62](#overview)

[ETW architecture 64](#etw-architecture)

[Implementing ETW instrumentation 65](#implementing-etw-instrumentation)

[Plan your instrumentation 65](#plan-your-instrumentation)

[Create a manifest file and implement your provider 66](#create-a-manifest-file-and-implement-your-provider)

[Compile the event manifest 67](#compile-the-event-manifest)

[Update your code 68](#update-your-code)

[Log and visualize events 69](#log-and-visualize-events)

[Performance Tools 70](#performance-tools)

[Download performance tools 71](#download-performance-tools)

[Understanding the Windows ADK tools 72](#understanding-the-windows-adk-tools) 

[Understanding the Windows Performance Toolkit 74](#understanding-the-windows-performance-toolkit)

[Setting up a test environment for ADK and WAS 75](#setting-up-a-test-environment-for-adk-and-was)

[Network topology considerations 76](#network-topology-considerations)

[Optional SQL database 78](#optional-sql-database)

[Symbol files, symbol server, symbol cache 78](#symbol-files-symbol-server-symbol-cache)

[Onboarding and preparing a system for ADK testing 78](#onboarding-and-preparing-a-system-for-adk-testing)

The preceding TOC was produced by Pandoc. I'm not sure if we'll keep any part of it.-->
