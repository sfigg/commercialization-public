---
author: joshbax-msft
title: Camera Driver Functional Test - Preview Stream - Preview video from each available type on the preview pin, stop and start the camera in between
description: Camera Driver Functional Test - Preview Stream - Preview video from each available type on the preview pin, stop and start the camera in between
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8f38ec5e-9d91-4799-870a-4ebcfbebf43e
---

# Camera Driver Functional Test - Preview Stream - Preview video from each available type on the preview pin, stop and start the camera in between
