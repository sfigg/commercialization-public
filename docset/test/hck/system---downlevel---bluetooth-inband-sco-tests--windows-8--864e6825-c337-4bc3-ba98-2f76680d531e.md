---
author: joshbax-msft
title: System - Downlevel - Bluetooth Inband SCO Tests (Windows 8)
description: System - Downlevel - Bluetooth Inband SCO Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8e25ffdb-2352-4c86-ad4d-eccfebd7a5be
---

# System - Downlevel - Bluetooth Inband SCO Tests (Windows 8)


This automated test runs the SCO tests. It requires two computers. The first computer acts as the primary computer the second acts as the secondary computer. The tests are copied locally to the WTTJobsWorking directory.
