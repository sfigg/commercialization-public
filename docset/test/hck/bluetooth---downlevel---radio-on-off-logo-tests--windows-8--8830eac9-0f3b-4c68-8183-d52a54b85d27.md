---
author: joshbax-msft
title: Bluetooth - Downlevel - Radio On-Off Logo Tests (Windows 8)
description: Bluetooth - Downlevel - Radio On-Off Logo Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 3de04d9d-6bee-4519-8e24-fff003f3c2d5
---

# Bluetooth - Downlevel - Radio On-Off Logo Tests (Windows 8)


This automated test requires 2 computers. The first computer acts as the primary and the other acts as secondary. The tests are copied locally to the WTTJobsWorking directory.
