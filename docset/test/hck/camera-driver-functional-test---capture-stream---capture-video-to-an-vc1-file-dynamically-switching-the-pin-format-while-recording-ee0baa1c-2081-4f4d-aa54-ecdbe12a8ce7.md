---
author: joshbax-msft
title: Camera Driver Functional Test - Capture Stream - Capture video to an VC1 file, dynamically switching the pin format while recording
description: Camera Driver Functional Test - Capture Stream - Capture video to an VC1 file, dynamically switching the pin format while recording
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 22aeb3a8-c0b7-4739-8867-851911a6a904
---

# Camera Driver Functional Test - Capture Stream - Capture video to an VC1 file, dynamically switching the pin format while recording
