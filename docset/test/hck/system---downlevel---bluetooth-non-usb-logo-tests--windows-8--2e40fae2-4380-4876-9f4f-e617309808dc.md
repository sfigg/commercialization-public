---
author: joshbax-msft
title: System - Downlevel - Bluetooth Non-USB Logo Tests (Windows 8)
description: System - Downlevel - Bluetooth Non-USB Logo Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 75b8b9bf-83dc-4207-94fb-8e0236af829a
---

# System - Downlevel - Bluetooth Non-USB Logo Tests (Windows 8)


This automated test runs the Bluetooth non-USB tests. It requires two computers. The first computer acts as the primary computer and the other acts as a secondary computer. The tests are copied locally to the WTTJobsWorking directory.
