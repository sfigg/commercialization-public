---
author: joshbax-msft
title: Camera Driver Basic Test - Image Stream - Take a GIF photo from the default type exposed by the photo pin
description: Camera Driver Basic Test - Image Stream - Take a GIF photo from the default type exposed by the photo pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0fbb05f7-a25d-46f8-aafd-7ee25a61530d
---

# Camera Driver Basic Test - Image Stream - Take a GIF photo from the default type exposed by the photo pin
