---
author: joshbax-msft
title: System - Bluetooth Inband SCO Tests (Windows v6.3)
description: System - Bluetooth Inband SCO Tests (Windows v6.3)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 9d1bcd59-8f65-4c79-a282-9ba0156b8fe4
---

# System - Bluetooth Inband SCO Tests (Windows v6.3)


This automated test runs the SCO tests. It requires two computers. Install the Bluetooth Test Driver (BTHCSTI) on both computers. The first computer acts as the primary and the second computer acts as a secondary. The tests are copied locally to the WTTJobsWorking directory.
...
<td><p>System.Client.BluetoothController.USB.ScoDataTransportLayer</p>
