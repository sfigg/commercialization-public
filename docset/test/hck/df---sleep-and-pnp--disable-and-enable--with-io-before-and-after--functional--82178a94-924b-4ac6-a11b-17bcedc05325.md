---
author: joshbax-msft
title: DF - Sleep and PNP (disable and enable) with IO Before and After (Functional)
description: DF - Sleep and PNP (disable and enable) with IO Before and After (Functional)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c599b30a-4caf-4efb-947d-ffcb72fe7141
---
