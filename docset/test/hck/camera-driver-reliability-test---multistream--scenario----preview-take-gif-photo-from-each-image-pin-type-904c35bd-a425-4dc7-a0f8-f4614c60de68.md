---
author: joshbax-msft
title: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take GIF Photo From each image pin type
description: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take GIF Photo From each image pin type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 4a3ec041-7d1a-401b-9760-7a14dffce1c9
---

# Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take GIF Photo From each image pin type
