---
author: joshbax-msft
title: Camera Driver Functional Test - Capture Stream - Capture video to an H264 file, dynamically switching the pin format while recording
description: Camera Driver Functional Test - Capture Stream - Capture video to an H264 file, dynamically switching the pin format while recording
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: e836eb98-3644-4a71-93f8-852eaa5cb334
---

# Camera Driver Functional Test - Capture Stream - Capture video to an H264 file, dynamically switching the pin format while recording
