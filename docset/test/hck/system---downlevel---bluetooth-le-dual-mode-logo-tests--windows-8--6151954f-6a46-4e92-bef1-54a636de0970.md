---
author: joshbax-msft
title: System - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)
description: System - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1e71d3c6-8ba7-4a3d-b0fb-e712bec70143
---

# System - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)


This automated test examines the Bluetooth certification requirements and verifies that the controller that you’re testing is using valid Bluetooth 4.0 specifications. It requires three computers. The first computer acts as the primary computer the other two acts as a secondary computer. The tests are copied locally to the WTTJobsWorking directory.
