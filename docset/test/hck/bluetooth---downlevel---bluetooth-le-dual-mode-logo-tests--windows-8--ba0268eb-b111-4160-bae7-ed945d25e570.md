---
author: joshbax-msft
title: Bluetooth - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)
description: Bluetooth - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 4ad77a13-7268-4303-9f0b-43e47bcfdc86
---

# Bluetooth - Downlevel - Bluetooth LE Dual-Mode Logo Tests (Windows 8)


This automated test examines the Bluetooth certification requirements and verifies that the controller that you’re testing is using valid Bluetooth 4.0 specifications. This test requires 3 computers. The first computer acts as the primary and the other two acts as secondary. The tests are copied locally to the WTTJobsWorking directory.
