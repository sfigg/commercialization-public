...
ms.assetid: d68eaba1-f4fd-46fa-98f4-c3db8c15f736
---
...
**Visual Basic**`Dim instance As TargetData``Dim value As String``value = instance.Key`

## Syntax


**Visual Basic**`Public MustOverride ReadOnly Property Key As String`

**C#**`public abstract string Key { get; }`
