---
author: joshbax-msft
title: WiFi Direct Proximity Tests - MultiMachine Stress
description: WiFi Direct Proximity Tests - MultiMachine Stress
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: a2954108-d068-4ae3-8154-c5be9c4dc5ed
---

# WiFi Direct Proximity Tests - MultiMachine Stress


This test repeatedly runs a basic end-to-end connection scenario by using the PeerFinder APIs over Wi-Fi Direct. The device under test (DUT) randomly selects an access point (AP) configuration for each iteration. The configurations include the following:

-   The DUT connects to no AP.

-   The DUT connects to a 2.4 GHz AP before a Wi-Fi Direct connection is established.

-   The DUT connects to a 5 GHz AP before a Wi-Fi Direct connection is established.

-   The DUT connects to a 2.4 GHz AP after a Wi-Fi Direct connection is established.

-   The DUT connects to a 5 GHz AP after a Wi-Fi Direct connection is established.
