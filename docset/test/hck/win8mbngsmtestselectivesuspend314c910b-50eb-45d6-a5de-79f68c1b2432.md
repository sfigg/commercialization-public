---
author: joshbax-msft
title: Win8.MBN.GSM.TestSelectiveSuspend
description: Win8.MBN.GSM.TestSelectiveSuspend
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: f51fdf6d-cae7-4927-b464-57e16041dae7
---

# Win8.MBN.GSM.TestSelectiveSuspend


This test evaluates the selective suspend abilities of a Mobile Broadband device. The test connects to the Internet and puts an IP filter in place to block all outbound traffic. The test then verifies the lack of traffic traversing the interface, which causes the interface to enter a selective suspend state.
...
<td><p>Device.Network.MobileBroadband.GSM.SupportUSBSelectiveSuspend</p>
