---
author: joshbax-msft
title: System - Downlevel - Bluetooth LE Logo Tests (Windows 8)
description: System - Downlevel - Bluetooth LE Logo Tests (Windows 8)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6f95e57f-0c7c-4dec-b0d1-dfe1268e078a
---

# System - Downlevel - Bluetooth LE Logo Tests (Windows 8)


This automated test runs the Bluetooth LE certification tests. It requires two computers. The first computer acts as the primary computer and the other acts as a secondary computer. The tests are copied locally to the WTTJobsWorking directory.
