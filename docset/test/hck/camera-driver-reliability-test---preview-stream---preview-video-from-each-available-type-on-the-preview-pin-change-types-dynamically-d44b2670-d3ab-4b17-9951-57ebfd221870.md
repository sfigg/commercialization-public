---
author: joshbax-msft
title: Camera Driver Reliability Test - Preview Stream - Preview video from each available type on the preview pin, change types dynamically
description: Camera Driver Reliability Test - Preview Stream - Preview video from each available type on the preview pin, change types dynamically
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 17a890d8-8854-4cb9-9cd1-989a7bdf27de
---

# Camera Driver Reliability Test - Preview Stream - Preview video from each available type on the preview pin, change types dynamically
