---
author: joshbax-msft
title: DF - PNP Cancel Remove Device Test (Functional)
description: DF - PNP Cancel Remove Device Test (Functional)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c45fb03f-a52b-4a59-b88e-b2324509b55a
---

# DF - PNP Cancel Remove Device Test (Functional)


This test uses EDT filter driver to cause IRP\_MN\_CANCEL\_REMOVE\_DEVICE to be sent to target device stacks.
