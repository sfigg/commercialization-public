---
author: joshbax-msft
title: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take JPEG Photo From each image pin type
description: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take JPEG Photo From each image pin type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1ff5bdf8-aaa8-456e-9ed4-1b92c788cb5d
---

# Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take JPEG Photo From each image pin type
