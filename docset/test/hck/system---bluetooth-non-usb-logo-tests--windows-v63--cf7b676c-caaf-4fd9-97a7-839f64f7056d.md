---
author: joshbax-msft
title: System - Bluetooth Non-USB Logo Tests (Windows v6.3)
description: System - Bluetooth Non-USB Logo Tests (Windows v6.3)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: aad0e611-92b4-4c55-bc34-d85205a53ff5
---

# System - Bluetooth Non-USB Logo Tests (Windows v6.3)


This automated test runs Bluetooth non-USB Logo Tests. It requires two computers. Install the Bluetooth Test Driver (BTHCSTI) on both computers. The first computer acts as the primary and the second computer acts as a secondary. The tests are copied locally to the WTTJobsWorking directory.
...
<td><p>System.Client.BluetoothController.NonUSB.NonUsbUsesMicrosoftsStack System.Client.BluetoothController.NonUSB.ScoSupport</p>
