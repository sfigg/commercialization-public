---
author: joshbax-msft
title: Win7.MBN.GSM.TestHomeProvider
description: Win7.MBN.GSM.TestHomeProvider
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d7711ecc-36f8-4292-9519-8fd2149c88ee
---

# Win7.MBN.GSM.TestHomeProvider


This automated test queries the device for the home provider and verifies the return values.
