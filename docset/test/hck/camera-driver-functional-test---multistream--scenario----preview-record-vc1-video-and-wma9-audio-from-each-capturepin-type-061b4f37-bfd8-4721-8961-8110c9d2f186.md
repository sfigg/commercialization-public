---
author: joshbax-msft
title: Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record VC1 Video and WMA9 Audio from each CapturePin Type
description: Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record VC1 Video and WMA9 Audio from each CapturePin Type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 44e19c40-4bc9-4d29-82aa-b8b903a9f9dd
---

# Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record VC1 Video and WMA9 Audio from each CapturePin Type
