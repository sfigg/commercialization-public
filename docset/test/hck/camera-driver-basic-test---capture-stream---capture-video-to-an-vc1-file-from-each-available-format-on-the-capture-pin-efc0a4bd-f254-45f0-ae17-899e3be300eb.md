---
author: joshbax-msft
title: Camera Driver Basic Test - Capture Stream - Capture video to an VC1 file from each available format on the capture pin
description: Camera Driver Basic Test - Capture Stream - Capture video to an VC1 file from each available format on the capture pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8b803e75-b93a-4619-8fc5-8ef1c084f344
---

# Camera Driver Basic Test - Capture Stream - Capture video to an VC1 file from each available format on the capture pin
