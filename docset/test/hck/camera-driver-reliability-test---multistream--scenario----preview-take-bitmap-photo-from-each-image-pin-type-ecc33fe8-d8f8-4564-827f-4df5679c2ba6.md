---
author: joshbax-msft
title: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take Bitmap Photo From each image pin type
description: Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take Bitmap Photo From each image pin type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d53d6af6-9c61-47b2-81ed-33a56b09bb81
---

# Camera Driver Reliability Test - MultiStream (Scenario) - Preview, Take Bitmap Photo From each image pin type
...
<td><p>Reliability Certification</p></td>
</tr>
<tr class="odd">
