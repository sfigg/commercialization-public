---
author: joshbax-msft
title: WiFi Direct Proximity Tests - MultiMachine ConnectDisconnect Host PreAP5
description: WiFi Direct Proximity Tests - MultiMachine ConnectDisconnect Host PreAP5
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8d711beb-3320-4812-a4c1-4c491de374a4
---

# WiFi Direct Proximity Tests - MultiMachine ConnectDisconnect Host PreAP5


This test verifies a basic connect and graceful disconnect scenario by using the PeerFinder APIs over Wi-Fi Direct. The device under test (DUT) connects to a 5 GHz AP before the test begins.
