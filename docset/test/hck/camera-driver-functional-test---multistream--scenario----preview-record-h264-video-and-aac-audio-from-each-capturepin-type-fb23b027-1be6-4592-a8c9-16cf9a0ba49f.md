---
author: joshbax-msft
title: Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record H.264 Video and AAC Audio from each CapturePin Type
description: Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record H.264 Video and AAC Audio from each CapturePin Type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d7649095-599d-458c-aa91-95075338f312
---

# Camera Driver Functional Test - MultiStream (Scenario) - Preview, Record H.264 Video and AAC Audio from each CapturePin Type
