---
author: joshbax-msft
title: System - Bluetooth LE Logo Tests (Windows v6.3)
description: System - Bluetooth LE Logo Tests (Windows v6.3)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1680f58b-c70b-4c33-98df-2e28ea2d8ead
---

# System - Bluetooth LE Logo Tests (Windows v6.3)


This automated test runs Bluetooth LE Logo Tests. It requires two computers. Install the Bluetooth Test Driver (BTHCSTI) on both computers. The first computer acts as the primary and the second computer acts as a secondary. The tests are copied locally to the WTTJobsWorking directory.
...
<td><p>System.Client.BluetoothController.Base.4LeSpecification System.Client.BluetoothController.Base.LEStateCombinations System.Client.BluetoothController.Base.LEWhiteList System.Client.BluetoothController.Base.SimultaneousBrEdrAndLeTraffic</p>
