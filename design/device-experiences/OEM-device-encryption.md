...
| | <ul><li>BitLocker check after firmware update</li><li>BitLocker Drive Encryption USB BIOS Logo Test </li><li>System - Partition Validation</li><li>BitLocker Tpm+PIN+ USB and Recovery Password </li><li>DE OOBE_EOW Sequence Tests</li></ul>|
